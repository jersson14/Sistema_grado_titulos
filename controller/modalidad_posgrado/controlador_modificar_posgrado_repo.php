<?php
    ...
    $propais = strtoupper(htmlspecialchars($_POST['propais'],ENT_QUOTES,'UTF-8'));
    $pro_unive = strtoupper(htmlspecialchars($_POST['pro_unive'],ENT_QUOTES,'UTF-8'));
    $pro_grado = htmlspecialchars($_POST['pro_grado'],ENT_QUOTES,'UTF-8');
    ...
    $consulta = $MMPOS->Modificar_Modalidad_repo_POSGRA($id,$modo,$mod_estu,$trabaj,$turni,$porce,$centro,$meta,$propais,$pro_unive,$pro_grado,$fechamatrimoda,$fechamodaini,$fechamodafin,$susten,$idusuer);
    echo $consulta;
