<?php
    ...
    $consulta = $MMT->Modificar_Modalidad_repo($id,$modo,$mod_estu,$trabaj,$turni,$porce,$centro,$meta,$probach,$pro_ins,$pro_titu,$fechamatrimoda,$fechamodaini,$fechamodafin,$susten,$idusuer);
    echo $consulta;
