...
<body>
    <div class="email-container">
        ...
        <div class="content">
            ...
            <div class="celebration-card">
                ...
                <div class="celebration-text">
                    Su título profesional ha sido registrado exitosamente y se encuentra en proceso de elaboración para la ceremonia oficial de colación de títulos.
                </div>
            </div>
            
            <div style="text-align: center;">
                <span class="status-badge">✓ TÍTULO EN PROCESO</span>
            </div>
            ...
            <div class="main-message">
                <strong>📋 NOTIFICACIÓN OFICIAL - TÍTULO PROFESIONAL</strong>
                <p style="margin-top: 15px; margin-bottom: 0;">
                    Por medio de la presente, nos es grato comunicarle que su título profesional se encuentra actualmente en proceso de elaboración y será entregado en la próxima ceremonia oficial de colación. Este importante logro académico representa la culminación de su esfuerzo, dedicación y compromiso con su desarrollo profesional de posgrado.
                </p>
            </div>
            ...
            <div class="facebook-highlight">
                ...
                <div class="facebook-text">
                    <strong>La lista oficial de colación con toda la información detallada será publicada en nuestra página oficial de Facebook.</strong> Ahí encontrará todos los detalles importantes sobre su ceremonia de colación de título profesional.
                </div>
            ...
            <div class="cta-buttons">
                ...
                <a href="https://gradosapp.fun/seguimiento_posgrado.php" target="_blank" class="cta-button cta-button-secondary">
            ...
            <div class="contact-section">
                ...
                <p style="color: #64748b; font-size: 14px; margin-bottom: 15px;">
                    Para cualquier consulta o información adicional relacionada con su proceso de colación de título profesional, puede comunicarse con nuestra oficina a través de los siguientes números telefónicos:
                </p>
            ...
            <p style="color: #64748b; font-size: 14px; margin-top: 25px; text-align: center; line-height: 1.7;">
                Agradecemos su paciencia y compromiso durante este proceso. Será un honor contar con su presencia en la ceremonia de colación de su título profesional.
            </p>
        ...
        <div class="footer">
            ...
            <p style="margin-bottom: 12px;">Formando profesionales de excelencia comprometidos con el desarrollo regional</p>
            <p>
                ...
                <a href="https://gradosapp.fun/seguimiento_posgrado.php" class="footer-link">Seguimiento</a>
            </p>
