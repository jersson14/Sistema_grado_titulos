...
<body class="hold-transition login-page" style="background-image: url('img/img1.jpg'); background-size: 25px 50px; background-size: 100% 100%;"  >
<div class="login-box">
  <div class="login-logo">
  <a href="index.php">
  <b style="font-family:'arial black'; font-size:28px; color:black; background-color:white; padding: 5px; border-radius: 10px;">
    SISTEMA DE CONTROL 
  </b>
  <b style="font-family:'arial black'; font-size:28px; color:black; background-color:white; padding: 5px; border-radius: 10px;">
    DE SANEAMIENTO
  ...
  <img src="img/incocat.png" alt="" width="100%" height="100%">		      	
    <p class="login-box-msg" style="font-family:Arial black; font-size:15px; color:black"><b>DATOS DEL USUARIO</b></p>
      ...
      <div class="row">
        ...
        <!-- /.col -->
        <div class="col-6">
          <button class="btn btn-primary btn-block" id="entrar" onclick=""><i class='fas fa-share-square ml-1 mr-1'></i>&nbsp;<b>Iniciar Sesión</b></button>
        </div>
        <!-- /.col -->
      </div>
      ...
      <div class="col-6">
      <p class="mb-1">
        <a href="seguimiento.php"><i class="fas fa-search" style="color:green"></i>   <b>Rastrear Trámite</b></a>
      </p>
      <p class="mb-1">
        <a href="registrar.php"><i class="fas fa-file-signature" style="color:green"></i>   <b>Nuevo Trámite</b></a>
      </p>
      </div>
