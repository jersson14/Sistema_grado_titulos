...
<?php if($_SESSION['S_ROL']=="Administrador") {?>
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav ml-auto" >
      ...
      <hr style="height:4vh; width:.1vw; border-width:0; color:#000; background-color:#BBBBBB;">
      <li class="nav-item dropdown" style="text-align:justify;">
        <a class="nav-link" data-toggle="dropdown" href="#" style="text-align:justify;">
        <i class="far fa-bell" title="Documentos pendientes"></i>
        <span class="badge badge-warning navbar-badge" id="lbl_contador_pendientes" style="text-align:justify"></span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right" style="text-align:justify">
        <div id="div_cuerpo_tramite" style="text-align:justify; border: 1px solid #333333;width: 100%;font-size: 100%;overflow-x: scroll;">
        </div>
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="index.php" class="brand-link">
      <img src="loj.jpg" alt="<?php echo $_SESSION['S_RAZON'];?>"  width="100%"  height="auto">
    </a>
