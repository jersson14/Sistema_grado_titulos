...
function listar_colacion() {
    tbl_colacion = $("#tabla_colacion").DataTable({
        ...
        "processing": true,
        "ajax": {
            "url": "../controller/colacion_posgrado/controlador_listar_colacion_pos.php",
            type: 'POST'
        },
        dom: 'Bfrtip',
        ...
        buttons: [
          {
              ...
              filename: function() {
                  return "LISTA DE COLACIONES POSGRADO";
              },
              title: function() {
                return "LISTA DE COLACIONES POSGRADO";
              },
...
function Registrar_colacion(){
  ...
  $.ajax({
    "url":"../controller/colacion_posgrado/controlador_registro_colacion_pos.php",
    type:'POST',
    data:{
        cola:cola,
...
function Modificar_Colacion(){
    ...
    $.ajax({
      "url":"../controller/colacion_posgrado/controlador_modificar_colacion_pos.php",
      type:'POST',
      data:{
          id:id,
          cola:cola,
...
function Imprimir_colacion() {
  ...
  var url = "../view/MPDF/REPORTE/colacion_posgrado.php?"
  ...
  window.open(url, "COLACION POSGRADO", "scrollbars=NO,width=" + width + ",height=" + height + ",top=0,left=0");
}