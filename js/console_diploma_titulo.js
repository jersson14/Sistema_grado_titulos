...
function listar_expedientes_titulado() {
  tbl_general_titulo = $("#tabla_registro_general").DataTable({
    ...
    processing: true,
    ajax: {
      url: "../controller/diplomas/controlador_listar_diploma_titulo.php",
      type: "POST",
    },
    dom: "Bfrtip",
    ...
    buttons: [
      {
        ...
        filename: function () {
          return "LISTA DE DIPLOMAS TITULO";
        },
        title: function () {
          return "LISTA DE DIPLOMAS TITULO";
        },
        ...
        render: function (data, type, row) {
          ...
          }
          {
            return (
              "<a href='../" +
              data +
              "' target='_blank'><button style='font-size:13px;' type='button' class='control btn btn-primary btn-sm' title='Ver Ver diploma escaneado'><i class='fas fa-file-download'></i> Ver diploma escaneado</button></a>  "
            );
          }
        },
      },
...
function listar_fechas_busqueda() {
  ...
  tbl_general_titulo = $("#tabla_registro_general").DataTable({
     "ordering":false,   
        ...
        "processing": true,
       "ajax": {
            "url": "../controller/diplomas/controlador_listar_diploma_titulo_fecha.php",
            "type": "POST",
            "data": {
...
$("#tabla_registro_general").on("click", ".mostrar", function () {
  ...
  document.getElementById("select_tipo_diplo").value =
    data.Diploma_tipo_emitido;
  document.getElementById("txt_fecha_inicio_tra").value =
  ...
  document.getElementById("txt_fecha_secre").value =
    ...
    success: function (resp) {
      if (resp > 0) {
        Swal.fire(
          ...
          "Se subir el diploma escaneado de forma correcta!!!",
          "success"
        ).then((value) => {
