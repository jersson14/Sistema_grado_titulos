...
function listar_expedientes_titulado(){
    tbl_expediente_titulado = $("#tabla_expediente_titulado").DataTable({
      "ordering":false,   
        ...
        "processing": true,
      "ajax":{
          "url":"../controller/expediente_titulado/controlador_listar_expediente_titulado.php",
          type:'POST'
      },
      dom: 'Bfrtip', 
      ...
      buttons: [
        {
          ...
          filename: function() {
            return "LISTA DE EXPEDIENTE TITULO";
          },
          title: function() {
            return "LISTA DE EXPEDIENTE TITULO";
          },
...
function listar_fechas_busqueda(){
    ...
    tbl_expediente_titulado = $("#tabla_expediente_titulado").DataTable({
        ...
        "processing": true,
        "ajax":{
            "url":"../controller/expediente_titulado/controlador_listar_expediente_titulo_fecha.php",
            type:'POST',
          data:{
...
$('#tabla_expediente_titulado').on('click','.mostrar',function(){
  var data = tbl_expediente_titulado.row($(this).parents('tr')).data();

  if(tbl_expediente_titulado.row(this).child.isShown()){
      var data = tbl_expediente_titulado.row(this).data();
  }
  ...
  document.getElementById('txt_titulo').value=data.Denominación_grado;
...
$('#tabla_expediente_titulado').on('click','.editar',function(){
  var data = tbl_expediente_titulado.row($(this).parents('tr')).data();
