     ...
     "buttons": [
      {
        ...
        exportOptions: {
            columns: [0, 1, 2, 3, 4, 5, 6, 7,8]  // Especifica las columnas a exportar hasta "fecha_registro1"
        }
      },
      {
        extend: 'pdfHtml5',
...
function listar_todo() {
    tbl_modalidad_titulo = $("#tabla_modalidad_titulo").DataTable({
        ...
        "processing": true,
        "ajax": {
            "url": "../controller/modalidad_titulo/controlador_listar_modalidad_titulo_todo.php",
            "type": 'POST'
        },
        "dom": 'Bfrtip',
       "buttons": [
...
function Modificar_Modalidad(){
    ...
    $.ajax({
      "url":"../controller/modalidad_titulo/controlador_modificar_facultad_repo.php",
      type:'POST',
      data:{
        id:id,
        modo:modo,
