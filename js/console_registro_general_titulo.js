...
function Registrar_Titulado() {
  ...
  if (moda === "") {
    ...
    return Swal.fire(
      "Mensaje de Advertencia",
      "Seleccione una modalidad en la segunda pestaña",
      "warning",
    );
  }
  if (esc === "") {
          ...
          $.ajax({
            ...
            success: function (resp) {
              ...
              if (resp == 1) {
                ...
                window.open(
                  "https://gradosapp.fun/view" + pdfResult.filepath,
                  "Informe por Escuela",
                  "scrollbars=NO,width=" +
                    screen.width +
                    ",height=" +
...
$("#tabla_registro_general").on("click", ".diploma", function () {
  ...
  var url =
    ...
    "&tamaño3=" +
    encodeURIComponent(tamaño3) +
    "&tamaño4=" +
    encodeURIComponent(tamaño4) +
    "#zoom=100%";
...
$("#tabla_registro_general").on("click", ".validar", function () {
  ...
  Swal.fire({
    title:
      "¿Desea validar el expediente del titulando: " + data.Estudiante + "?",
