...
function listar_fechas_busqueda(){
    ...
    let cede = document.getElementById('select_cede').value;
    ...
    tbl_expediente_titulado = $("#tabla_expediente_titulado").DataTable({
        ...
        "processing": true,
        "ajax":{
            "url":"../controller/reportes/controlador_listar_expediente_titulo_fecha_cede.php",
            "type":'POST',
          "data":{
        ...
        buttons: [
          {
            ...
            filename: function() {
                return "LISTA DE TITULADOS POR CEDE";
            },
            title: function() {
                return "LISTA DE TITULADOS POR CEDE";
            },
...
function listar_fechas_busqueda_bachi(){
    ...
    let cede = document.getElementById('select_cede_bach').value;
    ...
    tbl_expediente_bachiller = $("#tabla_expediente_bachiller").DataTable({
        ...
        "processing": true,
        "ajax":{
            "url":"../controller/reportes/controlador_listar_expediente_bachiller_fecha_cede.php",
          "type":'POST',
          "data":{
            fechainicio:fechainicio,
            fechafin:fechafin,
        ...
        buttons: [
          {
            ...
            titleAttr: 'Exportar a Excel',
            filename: function() {
                return "LISTA DE BACHILLERES POR CEDE";
            },
            title: function() {
              return "LISTA DE BACHILLERES POR CEDE";
            },
...
function Cargar_Select_Cede(){
  $.ajax({
    ...
    if(data.length>0){
      ...
      document.getElementById('select_cede_bach').innerHTML=cadena;
