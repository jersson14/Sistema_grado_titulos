...
function listar_fechas_busqueda(){
    ...
    let escu = document.getElementById('select_escuela').value;
    ...
    tbl_expediente_titulado = $("#tabla_expediente_titulado").DataTable({
        ...
        "processing": true,
        "ajax":{
            "url":"../controller/reportes/controlador_listar_expediente_titulo_fecha_escuela.php",
           "type":'POST',
          "data":{
        ...
        buttons: [
          {
            ...
            filename: function() {
                return "LISTA DE TITULADOS POR ESCUELA";
            },
            title: function() {
                return "LISTA DE TITULADOS POR ESCUELA";
            },
...
function listar_fechas_busqueda_bachi(){
    ...
    let escu = document.getElementById('select_escuela_bach').value;
    ...
    tbl_expediente_bachiller = $("#tabla_expediente_bachiller").DataTable({
        ...
        "processing": true,
        "ajax":{
            "url":"../controller/reportes/controlador_listar_expediente_bachiller_fecha_escuela.php",
             "type":'POST',
          "data":{
            fechainicio:fechainicio,
            fechafin:fechafin,
        ...
        buttons: [
          {
            ...
            titleAttr: 'Exportar a Excel',
            filename: function() {
                return "LISTA DE BACHILLERES POR ESCUELA";
            },
            title: function() {
              return "LISTA DE BACHILLERES POR ESCUELA";
            },
...
function Cargar_Select_Escuela(){
  $.ajax({
    "url":"../controller/reportes/controlador_cargar_select_escuela.php",
    type:'POST',
  }).done(function(resp){
    ...
    if(data.length>0){
      ...
      document.getElementById('select_escuela').innerHTML=cadena;
...
function Cargar_Select_Escuela_bach(){
    $.ajax({
      "url":"../controller/reportes/controlador_cargar_select_escuela_bach.php",
      type:'POST',
    }).done(function(resp){
      let data=JSON.parse(resp);
      if(data.length>0){
        ...
        document.getElementById('select_escuela_bach').innerHTML=cadena;
