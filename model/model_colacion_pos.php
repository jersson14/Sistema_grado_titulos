<?php
    ...
    class Modelo_Colacion_Pos extends conexionBD{
        

        public function Listar_Colaciones_Pos(){
            $c = conexionBD::conexionPDO();
            $sql = "CALL SP_LISTAR_COLACION_POS()";
            $arreglo = array();
            $query  = $c->prepare($sql);
            $query->execute();
        ...
        public function Registrar_Colacion_pos($cola,$fecha_cola,$fecha_conse,$fecha_firma,$fecha_resol,$oficio){
            $c = conexionBD::conexionPDO();
            $sql = "CALL SP_REGISTRAR_COLACION_POS(?,?,?,?,?,?)";
            $query  = $c->prepare($sql);
        ...
        public function Modificar_Colacion_pos($id,$cola,$fecha_cola,$fecha_conse,$fecha_firma,$fecha_resol,$oficio){
            $c = conexionBD::conexionPDO();
            $sql = "CALL SP_MODIFICAR_COLACION_POS(?,?,?,?,?,?,?)";
            $query  = $c->prepare($sql);
