<?php
    ...
    class Modelo_Usuario extends conexionBD{
        ...
        public function Registrar_Usuario($usu,$con,$ide,$ida,$rol,$sed){
            $c = conexionBD::conexionPDO();
        ...
        public function Modificar_Usuario($id,$ide,$ida,$rol,$sed){
            $c = conexionBD::conexionPDO();
        ...
        public function Cargar_Select_Datos_Seguimiento($dni){
            $c = conexionBD::conexionPDO();
            $sql = "CALL SP_CARGAR_SEGUIMIENTO_GRADUADO(?)";
            $arreglo = array();
            $query  = $c->prepare($sql);
        ...
        public function Cargar_Select_Datos_Seguimiento_pos($dni){
            $c = conexionBD::conexionPDO();
            $sql = "CALL SP_CARGAR_SEGUIMIENTO_GRADUADO_POSGRADO(?)";
            $arreglo = array();
            $query  = $c->prepare($sql);
            $query ->bindParam(1,$dni);
            $query->execute();
        ...
        public function Traer_Datos_Detalle_Seguimiento($codigo){
            $c = conexionBD::conexionPDO();
            $sql = "CALL SP_CARGAR_SEGUIMIENTO_GRADUADO_DETALLE(?)";
            $arreglo = array();
            $query  = $c->prepare($sql);
        ...
        public function Traer_Datos_Detalle_Seguimiento_posgrado($codigo){
            $c = conexionBD::conexionPDO();
            $sql = "CALL SP_CARGAR_SEGUIMIENTO_GRADUADO_DETALLE_POSGRADO(?)";
            $arreglo = array();
            $query  = $c->prepare($sql);
            $query ->bindParam(1,$codigo);
            $query->execute();
