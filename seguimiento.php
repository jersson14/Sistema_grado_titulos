    ...
    <nav class="main-header navbar navbar-expand-md navbar-light navbar-white">
      <div class="container">
        ...
        <a href="seguimiento.php" class="navbar-brand">
          ...
          <span class="brand-text font-weight-light"><b>SEGUIMIENTO DE EXPEDIENTE PREGRADO</b></span>
        </a>
                  ...
                  <div class="card-body">
                    <div class="row">
                      ...
                      <div class="col-md-6 col-sm-12 mb-3">
                        ...
                        <button class="btn btn-success w-100" style="font-size:18px" id="buscar" onclick="Traer_Datos_Seguimiento()">
                          <i class="fa fa-search"></i> Buscar Expediente Pregrado
                        </button>
                      </div>
                    </div>
                  </div>
