...
<div class="login-box">
  <div class="login-logo">
    <a href="index.php"><b style="font-family:'arial black'; font-size:28px; color:black">SISTEMA DE TRÁMITE DOCUMENTARIO WEB</b></a>
  </div>
  <!-- /.login-logo -->
  <div class="card">
    <div class="card-body login-card-body">
    <img src="img/diresa.png" alt="" width="100%" height="100%">		      	
