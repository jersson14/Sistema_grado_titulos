...
-- Tiempo de generación: 17-11-2024 a las 15:36:59
...
--
-- Base de datos: `u486624649_grados_titulos`
--
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_AGREGAR_DIPLOMA_POSGRADO` (IN `IDEXPE` CHAR(12), IN `ID` INT, IN `FECHACU` DATE, `FECHAFIRMA` DATE, IN `RESONUM` VARCHAR(30), IN `FECHARESO` DATE, IN `DIPLONUM` INT, IN `REGISNUM` INT, IN `REGISLIB` INT, IN `REGIFOL` VARCHAR(100), IN `TIPODIPLO` CHAR(1), IN `FECHA_INICI_TRAMI` DATE, IN `CREDI` INT, IN `OFICIO` VARCHAR(255), IN `FECHASECRE` DATE, IN `USU` INT)   BEGIN
DECLARE CANTIDAD INT;
DECLARE AÑO INT;
DECLARE MES INT;
DECLARE DIA INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_NUMERO_GENERAL` ()   SELECT 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_NUMERO_GENERAL_POS` ()   SELECT 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SEGUIMIENTO_GRADUADO` (IN `DNI` CHAR(8))   SELECT
estudiante.Dni, 
estudiante.Nombres,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SEGUIMIENTO_GRADUADO_DETALLE` (IN `CODIGO` CHAR(8))   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SEGUIMIENTO_GRADUADO_DETALLE_POSGRADO` (IN `CODIGO` CHAR(8))   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SEGUIMIENTO_GRADUADO_DETALLE_UNIFICADO` (IN `CODIGO` CHAR(8))   BEGIN
    SELECT
        e.Id_expediente,
        e.Id_cede,
        e.Dni,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SEGUIMIENTO_GRADUADO_POSGRADO` (IN `DNI` CHAR(8))   SELECT
estudiante_posgrado.Dni, 
estudiante_posgrado.Nombres,
estudiante_posgrado.Apellido_paterno,
estudiante_posgrado.Apellido_materno,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_AREA` ()   SELECT
	area.area_cod, 
	area.area_nombre, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_AREA_SOLO` ()   SELECT
area.area_cod,area.area_nombre
FROM area
WHERE area_estado="ACTIVO"$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_AUTORIDAD` ()   SELECT
autoridades.Cod_autoridad,
autoridades.Autoridad_3
FROM
autoridades$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_AUTORIDAD_POS` ()   SELECT
autoridades.Cod_autoridad,
autoridades.Autoridad_3
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_CARRERASOLO` ()   SELECT
	escuela_profesional.Id_escuela,
		facultad.Nombre, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_CARRERASOLO_TI` ()   SELECT
	escuela_profesional.Id_escuela,
		facultad.Nombre, 
	escuela_profesional.Nombre, 
	escuela_profesional.Cod_Escuela
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_CEDES` ()   SELECT
	cede.Id_cede, 
	cede.cede_nombre
FROM
	cede
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_CEDES_TI` ()   SELECT
	cede.Id_cede, 
	cede.cede_nombre
FROM
	cede
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_EMPLEADO` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_ESCUELAS` (IN `ID` INT)   SELECT
	escuela_profesional.Id_escuela,
		escuela_profesional.Nombre,  
	escuela_profesional.Cod_Escuela, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_ESCUELAS_TITU` (IN `ID` INT)   SELECT
	escuela_profesional.Id_escuela,
		escuela_profesional.Nombre,  
	escuela_profesional.Cod_Escuela, 
	facultad.Cod_facultad
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_ESCUELA_BACH` ()   SELECT
	escuela_profesional.Id_escuela,
		escuela_profesional.Nombre,  
	escuela_profesional.Cod_Escuela, 
	facultad.Cod_facultad
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_ESCUELA_TITU` ()   SELECT
	escuela_profesional.Id_escuela,
		escuela_profesional.Nombre,  
	escuela_profesional.Cod_Escuela, 
	facultad.Cod_facultad
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_ESTUDIANTES` ()   SELECT
	estudiante.Dni,
	CONCAT_WS(' ',estudiante.Nombres,estudiante.Apellido_paterno,estudiante.Apellido_materno)AS Estudiante, 
	estudiante.Codigo, 
	estudiante.Nombres, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_FACULTAD` ()   SELECT
	facultad.Cod_facultad, 
	facultad.Nombre, 
	autoridades.Autoridad_1, 
	autoridades.Autoridad_2, 
...
WHERE NOT facultad.Nombre='DIRECCIÓN POSGRADO' AND facultad.estado='ACTIVO'$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_CARGAR_SELECT_PROGRAMA` ()   SELECT
	programa_posgrado.Id_programa, 
	programa_posgrado.Nombre
FROM
	programa_posgrado$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_ELIMINAR_CEDE` (IN `ID` INT)   DELETE FROM cede WHERE Id_cede=ID$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_ELIMINAR_COLACION` (IN `ID` INT)   DELETE FROM colacion WHERE colacion.id_colacion=ID$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_ELIMINAR_REGISTRO_GENERAL` (IN `DNI` CHAR(8))   DELETE FROM estudiante WHERE estudiante.Dni=DNI$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_ELIMINAR_REGISTRO_POSGRADO` (IN `DNI` CHAR(8))   DELETE FROM estudiante_posgrado WHERE estudiante_posgrado.Dni=DNI$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_AREA` ()   SELECT
	area.area_cod, 
	area.area_nombre,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_AUTORIDAD` ()   SELECT
autoridades.Cod_autoridad,
autoridades.Autoridad_1,
autoridades.Cargo_auto1,
autoridades.Autoridad_2,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_CARRERAS` ()   SELECT
escuela_profesional.Id_escuela,
escuela_profesional.Cod_Escuela,
escuela_profesional.Nombre,
escuela_profesional.Grado_academico,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_CEDES` ()   SELECT
	cede.Id_cede, 
	cede.cede_nombre, 
	cede.descripcion, 
	cede.estado, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_COLACION` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_COLACION_POS` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_DIPLOMA_BACHILLER_FECHAS` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_DIPLOMA_FECHAS` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EMPLEADO` ()   SELECT
	empleado.empleado_id, 
	empleado.emple_nombre, 
	empleado.emple_apepat, 
	empleado.emple_apemat, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EMPRESA` ()   SELECT empresa_id,emp_razon,emp_email,emp_cod,emp_telefono,emp_direccion,emp_logo
FROM empresa$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_ESTUDIANTES` ()   SELECT
estudiante.Dni,
estudiante.Codigo,
estudiante.Nombres,
estudiante.Apellido_paterno,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_ESTUDIANTES_POS` ()   SELECT
estudiante_posgrado.Dni,
estudiante_posgrado.Codigo,
estudiante_posgrado.Nombres,
estudiante_posgrado.Apellido_paterno,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EXPEDIENTE_BACHILLER` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EXPEDIENTE_BACHILLER2` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EXPEDIENTE_BACHILLER_FECHAS` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EXPEDIENTE_MODALIDAD_FECHAS` (IN `FECHAINICIO` DATE, IN `FECHAFIN` DATE)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EXPEDIENTE_TITULADO` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EXPEDIENTE_TITULADO_FECHAS` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_EXPEDIENTE_TITULO2` ()   SELECT
	expediente.Id_expediente, 
	expediente.Id_cede, 
	expediente.Dni, 
	expediente.Id_escuela, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_FACULTAD` ()   SELECT
facultad.Cod_facultad,
facultad.Nombre,
facultad.estado,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_BACHI_FECHAS_CEDE` (IN `FECHAINI` DATE, IN `FECHAFI` DATE, IN `ID` INT)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
informe
  ...
  WHERE escuela_profesional.Grado_academico='BACHILLER' AND diploma.estado='CON DIPLOMA' AND expediente.created_at BETWEEN FECHAINI AND FECHAFI AND expediente.Id_cede=ID
ORDER BY
	 diploma.estado,diploma.updated_at  desc$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_FECHAS` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
estudiante.Codigo,
CONCAT_WS(' ', estudiante.Nombres, estudiante.Apellido_paterno, estudiante.Apellido_materno) AS Estudiante,
CONCAT_WS(' ',estudiante.Años_transcurridos,' años',estudiante.Meses_transcurridos,' meses y',estudiante.Dias_transcurridos,' días')as tiempotrancurrido,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_FECHAS_BACHILLER` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_POSGRADO_FECHAS` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
	estudiante_posgrado.Dni, 
	estudiante_posgrado.Codigo, 
	estudiante_posgrado.Nombres, 
	estudiante_posgrado.Apellido_paterno, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_POSGRADO_FECHAS_CEDE` (IN `FECHAINI` DATE, IN `FECHAFI` DATE, IN `ID` INT(2))   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
informe
  ...
  WHERE escuela_profesional.Grado_academico='TITULO' AND diploma.estado='CON DIPLOMA' AND expediente.created_at BETWEEN FECHAINI AND FECHAFI AND expediente.Id_cede=ID
ORDER BY
	 diploma.estado,diploma.updated_at  desc$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_POSGRADO_FECHAS_ESCU` (IN `FECHAINI` DATE, IN `FECHAFI` DATE, IN `ID` INT)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_POSGRADO_FECHAS_ESCU_BACH` (IN `FECHAINI` DATE, IN `FECHAFI` DATE, IN `ID` INT)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_POSGRADO_FECHAS_FACU` (IN `FECHAINI` DATE, IN `FECHAFI` DATE, IN `ID` INT)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_POSGRADO_FECHAS_FACU_BACHI` (IN `FECHAINI` DATE, IN `FECHAFI` DATE, IN `ID` INT)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_GENERAL_POSGRADO_FECHAS_SUNEDU` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
    empresa.emp_cod,
    empresa.emp_razon,
    programa_posgrado.Nombre as posgrado,
    estudiante_posgrado.Apellido_paterno,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_MODALIDAD_BACHILLER` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_MODALIDAD_TITULO` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_MODALIDAD_TITULO_FECHAS` (IN `FECHAINICIO` DATE, IN `FECHAFIN` DATE)   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_PROGRAMAS` ()   SELECT
	programa_posgrado.Id_programa, 
	programa_posgrado.Nombre, 
	programa_posgrado.Grado_academico, 
	programa_posgrado.Abreviatura_grado, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_ALUMNOS_POS` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_AUTO` ()   SELECT
	COUNT(autoridades.Cod_autoridad)AS TOTAL_programa
FROM
	autoridades$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_DIPLO_BACHILLER` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_DIPLO_TITULO` ()   SELECT
Count(diploma.Id_Diploma) AS total_diploma
FROM
diploma
INNER JOIN modalidad ON diploma.id_modalidad = modalidad.Id_modalidad
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_EMPLEADO` ()   select count(empleado_id) as total from empleado$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_ESCU` ()   SELECT DISTINCT
	COUNT(escuela_profesional.Id_escuela)AS TOTAL_ESCU
FROM
	escuela_profesional$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_EXPE_BACHILLER` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_EXPE_POS` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_EXPE_TITULO` ()   SELECT
Count(expediente.Id_expediente) AS total_expediente
FROM
diploma
INNER JOIN modalidad ON diploma.id_modalidad = modalidad.Id_modalidad
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_FACUL` ()   SELECT
	COUNT(facultad.Cod_facultad)AS TOTAL_FACU
FROM
	facultad$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_POSGRADOS` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_PREGRADO` ()   SELECT
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TOTAL_PROGRAM` ()   SELECT
	COUNT(programa_posgrado.Id_programa)AS TOTAL_programa
FROM
	programa_posgrado$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TRAE_AUTORI` (IN `ID` INT)   SELECT
	facultad.Cod_facultad, 
	facultad.Nombre, 
		autoridades.Cod_autoridad, 
	autoridades.Autoridad_1, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TRAE_AUTORI_POS` (IN `ID` INT)   SELECT
	programa_posgrado.Id_programa, 
	programa_posgrado.Nombre, 
	programa_posgrado.Grado_academico,
		autoridades.Cod_autoridad,  
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TRAE_GRADO` (IN `ID` INT)   SELECT
	escuela_profesional.Id_escuela,
		escuela_profesional.`Denominación_grado`, 
	escuela_profesional.Cod_Escuela
FROM
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TRAE_GRADO_POS` (IN `ID` INT)   SELECT
	programa_posgrado.Id_programa, 
	programa_posgrado.`Denominación_grado` 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_TRAE_GRADO_TITU` (IN `ID` INT)   SELECT
	escuela_profesional.Id_escuela,
		escuela_profesional.`Denominación_grado`, 
	escuela_profesional.Cod_Escuela
FROM
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTAR_USUARIO` ()   SELECT
	usuario.usu_id, 
	usuario.usu_usuario, 
	usuario.empleado_id, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTA_DIPLOMA_BACHILLER` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTA_DIPLOMA_TITULO` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTA_GENERAL` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTA_GENERAL_BACHILLER` ()   SELECT
expediente.Id_expediente,
expediente.Id_cede,
expediente.Dni,
expediente.Id_escuela,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTA_GENERAL_POSGRADO` ()   SELECT
	estudiante_posgrado.Dni, 
	estudiante_posgrado.Codigo, 
	estudiante_posgrado.Nombres, 
	estudiante_posgrado.Apellido_paterno, 
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_LISTA_GENERAL_PREGRADO_SNEDU` (IN `FECHAINI` DATE, IN `FECHAFI` DATE)   SELECT
empresa.emp_cod,
empresa.emp_razon,
estudiante.Apellido_paterno,
estudiante.Apellido_materno,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_AREA` (IN `ID` INT, IN `NAREA` VARCHAR(255), IN `ESTADO` VARCHAR(20))   BEGIN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_AUTORIDAD` (IN `ID` INT, IN `AUTO1` VARCHAR(100), IN `CARGO1` VARCHAR(100), IN `AUTO2` VARCHAR(100), IN `CARGO2` VARCHAR(100), IN `AUTO3` VARCHAR(100), IN `CARGO3` VARCHAR(100), IN `ESTADO` VARCHAR(20))   BEGIN
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_BACHILLER` (IN `NDOCUMENTO` CHAR(8), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `CODIGO` CHAR(15), IN `SEXO` VARCHAR(20), IN `MOVIL` CHAR(9), IN `DIRECCION` VARCHAR(255), IN `EMAPER` VARCHAR(255), IN `EMAINSTI` VARCHAR(255), IN `FECHAMATRI` DATE, IN `FECHAEGRE` DATE, IN `OBERSER` VARCHAR(255), IN `IDEXPE` CHAR(12), IN `CED` INT, IN `IDESCUE` INT, IN `BACH` VARCHAR(255), IN `MODA` VARCHAR(255), IN `IDAUTO` INT, IN `FECHA` DATE, IN `ACUER` VARCHAR(255), IN `RESOL` VARCHAR(255), IN `EXPE` VARCHAR(255), IN `LIB` VARCHAR(255), IN `FOLI` VARCHAR(255), IN `REGIS` VARCHAR(255), IN `RUTA` VARCHAR(255), IN `IDMODA` INT, IN `MODO_ESTU` VARCHAR(100), IN `TRABA_INV` VARCHAR(255), IN `TURNITIN` VARCHAR(20), IN `PORCENTAJE` CHAR(3), IN `CENTRO_INVE` VARCHAR(255), IN `REGLA_META` TEXT, IN `PRO_BACH` VARCHAR(255), IN `PRO_INST` VARCHAR(255), IN `PRO_TITU` VARCHAR(255), IN `FECHA_MATRI_MOD` DATE, IN `FECHA_INIC_MOD` DATE, IN `FECHA_FIN_MOD` DATE, IN `MODO_SUSTE` VARCHAR(20), IN `IDDIPLO` INT, IN `FECHACU` DATE, IN `FECHAFIRMA` DATE, IN `RESOLDIPLO` VARCHAR(30), IN `FECHARESO` DATE, IN `NUMDIPLO` INT, IN `REGINUM` INT, IN `REGISLIB` INT, IN `REGISFOL` INT, IN `TIPODIPLO` CHAR(1), IN `FECHA_INI_TRA` DATE, IN `NROCREDI` INT, IN `NROOFICIO` VARCHAR(255), IN `FECHASECRE` DATE, IN `USU` INT)   BEGIN
  DECLARE AÑO INT;
  DECLARE MES INT;
  DECLARE DIA INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_CARRERA` (IN `ID` INT, IN `ESCUE` CHAR(11), IN `NOMBRES` VARCHAR(100), IN `GRADOACA` VARCHAR(100), IN `ABRE` CHAR(2), IN `DENOMI` VARCHAR(100), IN `PROGRAMA` VARCHAR(100), IN `CRED` INT, IN `FACUL` INT, IN `ESTADO` VARCHAR(20))   BEGIN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_CEDE` (IN `ID` INT, IN `CED` VARCHAR(255), IN `DESCRIP` VARCHAR(255), IN `ESTA` VARCHAR(100))   BEGIN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_COLACION` (IN `ID` INT, IN `COLA` VARCHAR(255), IN `FECHACOLA` DATE, IN `FECHACONSEJO` DATE, IN `FECHAFIRMA` DATE, IN `FECHARESOL` DATE, IN `OFICIIO` VARCHAR(255))   BEGIN
DECLARE AÑO INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_COLACION_POS` (IN `ID` INT, IN `COLA` VARCHAR(255), IN `FECHACOLA` DATE, IN `FECHACONSEJO` DATE, IN `FECHAFIRMA` DATE, IN `FECHARESOL` DATE, IN `OFICIIO` VARCHAR(255))   BEGIN
DECLARE AÑO INT;
DECLARE FECHA_ACTUAL DATE;
DECLARE CANTIDAD INT;
SET @AÑO:=(SELECT YEAR(NOW()));
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_EMPLEADO` (IN `ID` INT, IN `NDOCUMENTO` CHAR(12), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `FECHA` DATE, IN `MOVIL` CHAR(9), IN `MODALIDAD` VARCHAR(255), IN `DIRECCION` VARCHAR(255), IN `EMAIL` VARCHAR(255), IN `ESTADO` VARCHAR(20))   BEGIN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_EMPLEADO_FOTO` (IN `ID` INT, IN `RUTA` VARCHAR(255))   UPDATE empleado SET
empl_fotoperfil=RUTA
WHERE empleado_id=ID$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_EMPRESA` (IN `ID` INT, IN `NOMBRE` VARCHAR(250), IN `EMAIL` VARCHAR(250), IN `COD` VARCHAR(10), IN `TELEFONO` VARCHAR(20), IN `DIRECCION` VARCHAR(250))   UPDATE empresa SET
	emp_razon=NOMBRE,
	emp_email=EMAIL,
	emp_cod=COD,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_EMPRESA_FOTO` (IN `ID` INT, IN `RUTA` VARCHAR(255))   UPDATE empresa SET
emp_logo=RUTA
WHERE empresa_id=ID$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_ESTUDIANTE` (IN `NDOCUMENTO` CHAR(8), IN `CODIGO` CHAR(15), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `SEXO` VARCHAR(20), IN `MOVIL` CHAR(9), IN `DIRECCION` VARCHAR(255), IN `FECHAMATRI` DATE, IN `FECHAEGRE` DATE, IN `IDUSER` INT)   BEGIN
DECLARE NDOCUMENTOACTUAL CHAR(12);
DECLARE CANTIDAD INT;
DECLARE AÑO INT;
DECLARE MES INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_ESTUDIANTE_POS` (IN `NDOCUMENTO` CHAR(8), IN `CODIGO` CHAR(15), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `SEXO` VARCHAR(20), IN `MOVIL` CHAR(9), IN `DIRECCION` VARCHAR(255), IN `FECHAMATRI` DATE, IN `FECHAEGRE` DATE, IN `IDUSER` INT)   BEGIN
DECLARE NDOCUMENTOACTUAL CHAR(12);
DECLARE CANTIDAD INT;
DECLARE AÑO INT;
DECLARE MES INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_FACULTAD` (IN `ID` INT, IN `FACULTAD` VARCHAR(50), IN `AUTO` INT, IN `ESTA` VARCHAR(20))   BEGIN
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_INFORME` (IN `ID` INT, IN `NUM` INT)   BEGIN
UPDATE informe
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_MODALIDAD_BACHILLER` (IN `ID_MODA` INT, IN `EXPE_ACT` CHAR(12), IN `EXPE` VARCHAR(12), IN `MODO_OB` VARCHAR(150), IN `MODO_ESTU` VARCHAR(100), IN `PRO_BACH` VARCHAR(255), IN `PRO_INST` VARCHAR(255), IN `PRO_TITU` VARCHAR(255), IN `USU` INT)   BEGIN
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_MODALIDAD_TITULO` (IN `ID_MODA` INT, IN `EXPE_ACT` CHAR(12), IN `EXPE` CHAR(12), IN `MODO_OB` VARCHAR(150), IN `MODO_ESTU` VARCHAR(100), IN `TRABA_INV` VARCHAR(255), IN `TURNITIN` VARCHAR(20), IN `PORCENTAJE` CHAR(3), IN `CENTRO_INVE` VARCHAR(255), IN `REGLA_META` TEXT, IN `PRO_BACH` VARCHAR(255), IN `PRO_INST` VARCHAR(255), IN `PRO_TITU` VARCHAR(255), IN `FECHA_MATRI_MOD` DATE, IN `FECHA_INIC_MOD` DATE, IN `FECHA_FIN_MOD` DATE, IN `MODO_SUSTE` VARCHAR(20), IN `USU` INT)   BEGIN
DECLARE CANTIDAD INT;
IF EXPE_ACT = EXPE THEN
	UPDATE modalidad SET
	Modo_obtencion=MODO_OB,
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_PROGRAMA` (IN `ID` INT, IN `NOMBRES` VARCHAR(100), IN `GRADOACA` VARCHAR(100), IN `ABRE` CHAR(2), IN `DENOMI` VARCHAR(100), IN `PROGRAMA` VARCHAR(100), IN `CRED` INT, IN `DIRE` INT, IN `ESTADO` VARCHAR(20))   BEGIN
DECLARE DENO VARCHAR(20);
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_TITULADO` (IN `NDOCUMENTO` CHAR(8), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `CODIGO` CHAR(15), IN `SEXO` VARCHAR(20), IN `MOVIL` CHAR(9), IN `DIRECCION` VARCHAR(255), IN `EMAPER` VARCHAR(255), IN `EMAINSTI` VARCHAR(255), IN `FECHAMATRI` DATE, IN `FECHAEGRE` DATE, IN `OBERSER` VARCHAR(255), IN `IDEXPE` CHAR(12), IN `CED` INT, IN `IDESCUE` INT, IN `TITU` VARCHAR(255), IN `MODA` VARCHAR(255), IN `ID_AUTO` INT, IN `FECHA` DATE, IN `ACTOACA` VARCHAR(255), IN `ACUER` VARCHAR(255), IN `RESOL` VARCHAR(255), IN `EXPE` VARCHAR(255), IN `LIB` VARCHAR(255), IN `FOLI` VARCHAR(255), IN `REGIS` VARCHAR(255), IN `RUTA` VARCHAR(255), IN `IDMODA` INT, IN `MODO_ESTU` VARCHAR(100), IN `TRABA_INV` VARCHAR(255), IN `TURNITIN` VARCHAR(20), IN `PORCENTAJE` CHAR(3), IN `CENTRO_INVE` VARCHAR(255), IN `REGLA_META` TEXT, IN `PRO_BACH` VARCHAR(255), IN `PRO_INST` VARCHAR(255), IN `PRO_TITU` VARCHAR(255), IN `FECHA_MATRI_MOD` DATE, IN `FECHA_INIC_MOD` DATE, IN `FECHA_FIN_MOD` DATE, IN `MODO_SUSTE` VARCHAR(20), IN `IDDIPLO` INT, IN `FECHACU` DATE, IN `FECHAFIRMA` DATE, IN `RESOLDIPLO` VARCHAR(30), IN `FECHARESO` DATE, IN `NUMDIPLO` INT, IN `REGINUM` INT, IN `REGISLIB` INT, IN `REGISFOL` INT, IN `TIPODIPLO` CHAR(1), IN `FECHA_INI_TRA` DATE, IN `NROCREDI` INT, IN `NROOFICIO` VARCHAR(255), IN `FECHASECRE` DATE, IN `USU` INT)   BEGIN
  DECLARE AÑO INT;
  DECLARE MES INT;
  DECLARE DIA INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_USUARIO` (IN `ID` VARCHAR(255), IN `IDEMPLEADO` INT, IN `IDAREA` INT, IN `ROL` VARCHAR(25))   UPDATE usuario SET
usuario.empleado_id = IDEMPLEADO,
usuario.area_id=IDAREA,
usuario.usu_rol=ROL
WHERE usuario.usu_id=ID$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_USUARIO_CONTRA` (IN `ID` INT, IN `CONTRA` VARCHAR(250))   UPDATE usuario SET
usuario.usu_contra=CONTRA
WHERE usuario.usu_id=ID$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_MODIFICAR_USUARIO_ESTATUS` (IN `ID` INT, IN `ESTATUS` VARCHAR(20))   UPDATE usuario SET
usuario.usu_estatus=ESTATUS
WHERE usuario.usu_id=ID$$

CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_AREA` (IN `NAREA` VARCHAR(255))   BEGIN
DECLARE CANTIDAD INT;
SET @CANTIDAD:=(SELECT COUNT(*) FROM area where area_nombre=NAREA);
IF @CANTIDAD = 0 THEN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_AUTORIDAD` (IN `AUTO1` VARCHAR(100), IN `CARGO1` VARCHAR(100), IN `AUTO2` VARCHAR(100), IN `CARGO2` VARCHAR(100), IN `AUTO3` VARCHAR(100), IN `CARGO3` VARCHAR(100))   BEGIN
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_CARRERAS` (IN `ESCUE` CHAR(11), IN `NOMBREES` VARCHAR(100), IN `GRADOACA` VARCHAR(100), IN `ABRE` CHAR(2), IN `DENOMI` VARCHAR(100), IN `PROGRAMA` VARCHAR(100), IN `CRED` INT, IN `FACUL` INT)   BEGIN
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_CEDES` (IN `CED` VARCHAR(255), IN `DESCRIP` VARCHAR(255))   BEGIN
DECLARE CANTIDAD INT;
SET @CANTIDAD:=(SELECT COUNT(*) FROM cede where cede_nombre=CED);
IF @CANTIDAD = 0 THEN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_COLACION` (IN `COLA` VARCHAR(255), IN `FECHACOLA` DATE, IN `FECHACONSEJO` DATE, IN `FECHAFIRMA` DATE, IN `FECHARESOL` DATE, IN `OFICIIO` VARCHAR(255))   BEGIN
DECLARE CANTIDAD INT;
DECLARE AÑO INT;
DECLARE ULID INT;
SET @AÑO:=(SELECT YEAR(NOW()));
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_COLACION_POS` (IN `COLA` VARCHAR(255), IN `FECHACOLA` DATE, IN `FECHACONSEJO` DATE, IN `FECHAFIRMA` DATE, IN `FECHARESOL` DATE, IN `OFICIIO` VARCHAR(255))   BEGIN
DECLARE CANTIDAD INT;
DECLARE AÑO INT;
DECLARE ULID INT;
SET @AÑO:=(SELECT YEAR(NOW()));
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_EMPLEADO` (IN `NDOCUMENTO` CHAR(12), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `FECHA` DATE, IN `MOVIL` CHAR(9), `MODALIDAD` VARCHAR(255), IN `DIRECCION` VARCHAR(255), IN `EMAIL` VARCHAR(255))   BEGIN
DECLARE CANTIDAD INT;
SET @CANTIDAD:=(SELECT COUNT(*) FROM empleado WHERE emple_nrodocumento=NDOCUMENTO);
IF @CANTIDAD=0 THEN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_ESTUDIANTES` (IN `NDOCUMENTO` CHAR(8), IN `CODIGO` CHAR(15), IN `NOMBRE` VARCHAR(150), IN `APEPAT` VARCHAR(100), IN `APEMAT` VARCHAR(100), IN `SEXO` VARCHAR(20), IN `MOVIL` CHAR(9), IN `DIRECCION` VARCHAR(255), IN `FECHAMATRI` DATE, IN `FECHAEGRE` DATE, IN `IDUSER` INT)   BEGIN
DECLARE CANTIDAD INT;
DECLARE AÑO INT;
DECLARE MES INT;
DECLARE DIA INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_EXPEDIENTE_BA` (IN `CED` INT, IN `DNI` CHAR(8), IN `IDESCUE` INT, IN `DENO` VARCHAR(255), IN `ACUER` VARCHAR(255), IN `RESOL` VARCHAR(255), IN `FECHA` DATE, IN `EXPE` VARCHAR(255), IN `LIB` VARCHAR(255), IN `FOLI` VARCHAR(255), IN `REGIS` VARCHAR(255), IN `RUTA` VARCHAR(255), IN `AUTORIDAD` INT, IN `IDUSER` INT)   BEGIN
DECLARE cantidad INT;
DECLARE cod char(12);
SET @cantidad :=(SELECT IFNULL(MAX(doc_ncorrelativo),0) FROM expediente );
IF @cantidad >= 1 AND @cantidad <= 8 THEN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_EXPEDIENTE_TI` (IN `CED` INT, IN `DNI` CHAR(8), IN `IDESCUE` INT, IN `TITU` VARCHAR(255), IN `MODA` VARCHAR(255), IN `ACTOACA` VARCHAR(255), IN `ACUER` VARCHAR(255), IN `RESOL` VARCHAR(255), IN `FECHA` DATE, IN `EXPE` VARCHAR(255), IN `LIB` VARCHAR(255), IN `FOLI` VARCHAR(255), IN `REGIS` VARCHAR(255), IN `RUTA` VARCHAR(255), IN `AUTORIDAD` INT, IN `IDUSER` INT)   BEGIN
DECLARE cantidad INT;
DECLARE cod char(12);
SET @cantidad :=(SELECT IFNULL(MAX(doc_ncorrelativo),0) FROM expediente );
IF @cantidad >= 1 AND @cantidad <= 8 THEN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_FACULTAD` (IN `FACULTAD` VARCHAR(50), IN `AUTO` INT)   BEGIN
DECLARE CANTIDAD INT;
SET @CANTIDAD:=(SELECT COUNT(*) FROM facultad WHERE Nombre=FACULTAD AND Cod_autoridad=AUTO);
IF @CANTIDAD=0 THEN
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_MODALIDAD_BACHILLER` (IN `EXPE` CHAR(12), IN `MODO_OB` VARCHAR(150), IN `MODO_ESTU` VARCHAR(100), IN `PRO_BACH` VARCHAR(255), IN `PRO_INST` VARCHAR(255), IN `PRO_TITU` VARCHAR(255), IN `USU` INT)   BEGIN
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_PROGRAMA` (IN `NOMBRES` VARCHAR(100), IN `GRADOACA` VARCHAR(100), IN `ABRE` CHAR(2), IN `DENOMI` VARCHAR(100), IN `PROGRAMA` VARCHAR(100), IN `CRED` INT, IN `DIRE` INT)   BEGIN
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_REGISTRAR_USUARIO` (IN `USU` VARCHAR(255), IN `CONTRA` VARCHAR(255), IN `IDEMPLEADO` INT, IN `IDAREA` INT, IN `ROL` VARCHAR(25))   BEGIN
DECLARE CANTIDAD INT;
...
CREATE DEFINER=`u486624649_jerry`@`127.0.0.1` PROCEDURE `SP_VERIFICAR_USUARIO` (IN `USU` VARCHAR(255))   SELECT
	usuario.usu_id, 
	usuario.usu_usuario, 
	usuario.usu_contra, 
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='Entidad Area' ROW_FORMAT=DYNAMIC;
...
(2, 'SISTEMA WEB', '2024-09-29 18:08:02', 'ACTIVO', NULL, NULL),
(16, 'GRADOS Y TITULOS', '2024-09-17 14:34:17', 'ACTIVO', NULL, NULL),
(17, 'REPOSITORIO', '2024-09-17 18:27:14', 'INACTIVO', NULL, NULL),
(18, 'DECANATURA', '2024-09-29 16:03:17', 'ACTIVO', NULL, NULL);
...
(1, 'DR. ZENON HUMBERTO AREVALO MEZARINA', 'RECTOR', 'ABOG. JIOVANNA ARCE DEL CASTILLO', 'SECRETARIA GENERAL', 'MG. JUAN ALARCON CAMACHO', 'DECANO', '2024-05-25 22:19:18', '2024-08-16 17:00:44', 2, 'ACTIVO'),
(2, 'DR. ZENON HUMBERTO AREVALO MEZARINA', 'RECTOR', 'ABOG. JIOVANNA ARCE DEL CASTILLO', 'SECRETARIA GENERAL', 'MG. BONIFACIO ROBLES AGUIRRE', 'DECANO', '2024-05-30 21:55:20', '2024-06-02 10:40:51', 2, 'ACTIVO'),
(3, 'DR. ZENON HUMBERTO AREVALO MEZARINA', 'RECTOR', 'ABOG. JIOVANNA ARCE DEL CASTILLO', 'SECRETARIA GENERAL', 'MG. GILDA LUCY LOAYZA ROJAS ', 'DECANO', '2024-05-30 21:56:25', '2024-06-15 09:08:06', 2, 'ACTIVO'),
(9, 'DR. ZENON HUMBERTO AREVALO MEZARINA', 'RECTOR', 'ABOG. JIOVANNA ARCE DEL CASTILLO', 'SECRETARIA GENERAL', 'MAG. ALFREDO MARISCAL ZÚNIGA', 'DIRECTOR', '2024-09-17 14:42:24', '2024-09-17 14:42:42', 2, 'ACTIVO');
...
(9, 2024, '9 DE NOVIEMBRE', '2024-11-05', '2024-11-05', '2024-11-05', '2024-11-05', '121', 'VIGENTE', '2024-11-05', '0000-00-00 00:00:00');
...
(4, 2024, '03 DE OCTUBRE DE 2024', '2024-10-03', '2024-09-29', '2024-09-29', '2024-09-29', '6226', 'VIGENTE', '2024-09-29', '0000-00-00 00:00:00');
...
(3, '2024-09-25', '2024-09-20', 1349, '2024-09-20', 14463, 31755, 321, '310', 'O', '2024-09-29', '2024-09-29', 0, 0, 0, 220, '555', '2024-09-25', 2, 3, 4, '2024-09-29', '2024-09-29 15:34:53', 'CON DIPLOMA'),
(4, '2024-09-25', '2024-09-20', 1350, '2024-09-20', 14464, 31756, 322, '310', 'O', '2024-09-29', '2024-09-29', 0, 0, 0, 220, '599', '2024-09-25', 2, 4, 4, '2024-09-29', '2024-09-29 15:37:37', 'CON DIPLOMA'),
(5, '2024-09-29', '2024-09-29', 1351, '2024-09-29', 14465, 31757, 323, '310 -311', 'O', '2024-09-29', '2024-09-29', 0, 0, 0, 220, '122', '2024-10-03', 2, 5, 5, '2024-09-29', '2024-09-29 16:14:02', 'CON DIPLOMA'),
(6, '2024-09-29', '0000-00-00', 0, '2024-09-29', 0, 0, 0, '0', '', '0000-00-00', '2024-09-29', NULL, NULL, NULL, 0, '', '0000-00-00', 2, 6, 9, '2024-09-29', '2024-09-29 00:00:00', 'SIN DIPLOMA'),
(7, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 14, 7, 9, '2024-09-29', '2024-09-29 16:42:05', 'SIN DIPLOMA'),
(41, '2024-10-17', '0000-00-00', 0, '2024-10-17', 0, 0, 0, '0', '', '0000-00-00', '2024-10-24', NULL, NULL, NULL, 0, '', '0000-00-00', 2, 41, 9, '2024-10-22', '2024-10-24 00:00:00', 'SIN DIPLOMA'),
(42, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 10, 42, 9, '2024-10-22', '2024-10-22 14:37:36', 'SIN DIPLOMA'),
(44, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 17, 44, 9, '2024-10-24', '2024-10-24 16:19:18', 'SIN DIPLOMA'),
(45, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 17, 45, 9, '2024-10-24', '2024-10-24 16:21:19', 'SIN DIPLOMA'),
(46, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 17, 46, 9, '2024-10-24', '2024-10-24 16:26:23', 'SIN DIPLOMA'),
(47, '2024-11-05', '2024-11-05', 1355, '2024-11-05', 14469, 31761, 327, '310 -311', 'O', '2024-11-05', '2024-11-05', 0, 0, 0, 220, '121', '2024-11-05', 11, 47, 9, '2024-10-24', '2024-11-05 16:44:35', 'CON DIPLOMA'),
(48, '2024-11-05', '2024-11-05', 1354, '2024-11-05', 14468, 31760, 326, '310 -311', 'O', '2024-11-05', '2024-11-05', 0, 0, 0, 220, '121', '2024-11-05', 11, 48, 9, '2024-10-24', '2024-11-05 16:44:08', 'CON DIPLOMA'),
(49, '2024-10-30', '2024-10-30', 1353, '2024-10-30', 14467, 31759, 325, '310 -311', 'O', '2024-11-05', '2024-11-05', 0, 0, 0, 220, '213', '2024-10-30', 11, 49, 9, '2024-10-24', '2024-11-05 16:43:42', 'CON DIPLOMA'),
(50, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 17, 50, 9, '2024-10-28', '2024-10-28 14:38:43', 'SIN DIPLOMA'),
(52, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 18, 52, 9, '2024-11-08', '2024-11-08 14:24:38', 'SIN DIPLOMA'),
(53, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 18, 53, 9, '2024-11-08', '2024-11-08 14:26:17', 'SIN DIPLOMA'),
(54, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 18, 54, 9, '2024-11-08', '2024-11-08 14:27:30', 'SIN DIPLOMA'),
(55, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 18, 55, 9, '2024-11-08', '2024-11-08 14:28:43', 'SIN DIPLOMA'),
(56, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 18, 56, 9, '2024-11-08', '2024-11-08 14:36:37', 'SIN DIPLOMA'),
(57, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 18, 57, 9, '2024-11-08', '2024-11-08 14:37:19', 'SIN DIPLOMA'),
(58, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 18, 58, 9, '2024-11-08', '2024-11-08 14:38:06', 'SIN DIPLOMA'),
(61, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 17, 61, 9, '2024-11-12', '2024-11-12 14:44:27', 'SIN DIPLOMA'),
(62, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 17, 62, 9, '2024-11-14', '2024-11-14 20:50:54', 'SIN DIPLOMA'),
(63, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 17, 63, 9, '2024-11-14', '2024-11-14 20:52:41', 'SIN DIPLOMA'),
(64, '0000-00-00', '0000-00-00', 0, '', 0, 0, 0, '', '', '0000-00-00', '0000-00-00', 0, 0, 0, 0, '', '', 17, 64, 9, '2024-11-15', '2024-11-15 19:24:57', 'SIN DIPLOMA');
...
(1, '2024-09-29', '2024-09-29', '405', '2024-09-29', 11, 10, 1, '02-03', 'O', '2024-09-29', '2024-09-29', 0, 0, 0, 48, '35', '2024-10-03', 2, 1, 4, '0000-00-00', '2024-09-29 15:48:10', 'CON DIPLOMA'),
(2, '2024-09-29', '2024-09-29', '406', '2024-09-29', 12, 11, 2, '02-03', 'O', '2024-09-29', '2024-09-29', 0, 0, 0, 48, '35', '2024-10-03', 2, 2, 4, '0000-00-00', '2024-09-29 15:50:23', 'CON DIPLOMA');
...
(13, 'FIDEL', 'LIMACHIO', 'CABEZAS', '2024-09-17', '1965-06-15', '31129767', '951667981', 'CAS', 'fidel21@gmail.com', 'ACTIVO', 'JR. CANADA N° 123', 'controller/empleado/FOTOS/usuario.png', NULL, NULL),
(14, 'ERIKA', 'SALAS', 'ARAUJO', '2024-09-17', '1990-08-14', '45740202', '983664538', 'CAS', 'Brityey20a@hotmail.com', 'ACTIVO', 'AV. MARIÑO S/N', 'controller/empleado/FOTOS/usuario.png', NULL, NULL),
(15, 'ANTONIO', 'AVALOS', 'SALINAS', '2024-09-17', '1993-01-15', '61679166', '914057661', 'CAS', 'antonio.avalossalinas@gmail.com', 'ACTIVO', 'AV. PANAMERICA S/N', 'controller/empleado/FOTOS/usuario.png', NULL, NULL),
(16, 'ADMIN', 'ADMIN', 'ADMIN', '2024-09-29', '1990-02-12', '51511515', '952662626', 'CAS', 'admin21@gmail.com', 'ACTIVO', 'JR. CUSCO', 'controller/empleado/FOTOS/usuario.png', NULL, NULL),
(17, 'SECRE', 'SECRE', 'SECRE', '2024-09-29', '1990-04-24', '65656562', '922626262', 'CAS', 'secr21@gmail.com', 'ACTIVO', 'AV. CANADA', 'controller/empleado/FOTOS/usuario.png', NULL, NULL),
(18, 'LEONIDAS', 'SORIA', 'SORIA', '2024-10-02', '1980-04-15', '31005012', '936161616', 'CAS', 'soria12@gmail.com', 'ACTIVO', 'JR. CUSCO N° 487', 'controller/empleado/FOTOS/usuario.png', NULL, NULL),
(19, 'LUI', 'CHONG', 'CHONG', '2024-10-02', '1985-04-20', '41072815', '962662626', 'CAS', 'chong12@gmail.com', 'ACTIVO', 'AV. CANADA S/N', 'controller/empleado/FOTOS/usuario.png', NULL, NULL),
(20, 'JOSE', 'JOSE', 'JOSE', '2024-10-05', '1990-05-04', '40032356', '959955959', 'CAS', 'jose1221@gmail.com', 'ACTIVO', 'AV. CUSCO N° 212', 'controller/empleado/FOTOS/usuario.png', NULL, NULL),
(21, 'ABIGAIL', 'ABIGAIL', 'ABIGAIL', '2024-10-05', '1990-07-15', '46669356', '965126611', 'CAS', 'abigail12@gmail.com', 'ACTIVO', 'JR. ANDAHUAYLAS N° 211', 'controller/empleado/FOTOS/usuario.png', NULL, NULL);
...
(2, 'UNIVERSIDAD MAYOR DE SAN SIMON', 'UTEA@GMAIL.COM', '401', '(083) 321559', 'AV. PERU Nº 700 ABANCAY, APURíMAC, PERU', 'controller/empresa/FOTOS/IMG17-9-2024-15-911.png', '2024-05-25 21:53:36', NULL);
...
(1, 'EPISI', 'Ingeniería de Sistemas e Informática', 'TITULO', 'T', 'Ingeniero de Sistemas e Informática', 'CICLO REGULAR', 220, 1, '2024-09-17 17:29:15', '2024-09-17 19:42:15', 'ACTIVO'),
(2, 'EPISI', 'Ingeniería de Sistemas', 'BACHILLER', 'B', 'Ingeniería de Sistemas e Informática', 'CICLO REGULAR', 220, 1, '2024-09-17 17:29:47', '2024-09-17 19:42:59', 'ACTIVO'),
(3, 'EPIC', 'Ingeniería Civil', 'TITULO', 'T', 'Ingeniero Civil', 'CICLO REGULAR', 220, 1, '2024-09-17 17:46:28', '2024-09-17 19:42:27', 'ACTIVO'),
(4, 'EPIC', 'Ingeniería Civil', 'BACHILLER', 'B', 'Ingeniería Civil', 'CICLO REGULAR', 220, 1, '2024-09-17 17:46:59', '2024-09-17 19:43:05', 'ACTIVO'),
(5, 'EPA', 'Agronomía', 'TITULO', 'T', 'Ingeniero Agronomo', 'CICLO REGULAR', 220, 1, '2024-09-17 19:13:15', '2024-09-17 19:42:46', 'ACTIVO'),
(6, 'EPA', 'Agronomía', 'BACHILLER', 'B', 'Ciencias Agrarias', 'CICLO REGULAR', 220, 1, '2024-09-17 19:13:31', '2024-09-17 19:45:11', 'ACTIVO'),
(7, 'EPIARN', 'Ingeniería Ambiental y Recursos Naturales', 'TITULO', 'T', 'Ingeniero Ambiental', 'CICLO REGULAR', 220, 1, '2024-09-17 19:14:47', '2024-09-17 19:42:36', 'ACTIVO'),
(8, 'EPIARN', 'Ingeniería Ambiental y Recursos Naturales', 'BACHILLER', 'B', 'Ingeniería Ambiental y Recursos Naturales', 'CICLO REGULAR', 220, 1, '2024-09-17 19:15:16', '2024-09-17 19:43:14', 'ACTIVO'),
(9, 'EPD', 'Derecho', 'TITULO', 'T', 'Abogado', 'CICLO REGULAR', 256, 3, '2024-09-17 19:17:17', '2024-09-17 19:45:19', 'ACTIVO'),
(10, 'EPD', 'Derecho', 'BACHILLER', 'B', 'Derecho', 'CICLO REGULAR', 256, 3, '2024-09-17 19:18:39', '2024-09-17 19:44:21', 'ACTIVO'),
(11, 'EPC', 'Contabilidad', 'BACHILLER', 'B', 'Ciencias Contables y Financieras', 'CICLO REGULAR', 220, 3, '2024-09-17 19:19:31', '2024-09-17 19:44:58', 'ACTIVO'),
(12, 'EPC', 'Contabilidad', 'TITULO', 'T', 'Contador Público', 'CICLO REGULAR', 220, 3, '2024-09-17 19:19:53', '2024-09-17 19:44:33', 'ACTIVO'),
(13, 'EPTHG', 'Turismo, Hotelería y Gastronomía', 'TITULO', 'T', 'Turismo, Hotelería y Gastronomía', 'CICLO REGULAR', 220, 3, '2024-09-17 19:20:54', '2024-09-17 23:01:10', 'ACTIVO'),
(14, 'EPTHG', 'Turismo, Hotelería y Gastronomía', 'BACHILLER', 'B', 'Turismo, Hotelería y Gastronomía', 'CICLO REGULAR', 220, 3, '2024-09-17 19:21:10', '2024-09-17 19:41:35', 'ACTIVO'),
(15, 'EPE', 'Enfermería', 'BACHILLER', 'B', 'Enfermería', 'CICLO REGULAR', 220, 2, '2024-09-17 19:21:45', '2024-09-17 19:43:32', 'ACTIVO'),
(16, 'EPE', 'Enfermería', 'TITULO', 'T', 'Enfermería', 'CICLO REGULAR', 220, 2, '2024-09-17 19:22:04', '2024-09-17 19:43:26', 'ACTIVO'),
(17, 'EPES', 'Estomatología', 'BACHILLER', 'B', 'Estomatología', 'CICLO REGULAR', 220, 2, '2024-09-17 19:22:43', '2024-09-18 16:56:54', 'ACTIVO'),
(18, 'EPES', 'Estomatología', 'TITULO', 'T', 'Cirujano Dentista', 'CICLO REGULAR', 220, 2, '2024-09-17 19:23:02', '2024-09-17 19:44:43', 'ACTIVO'),
(19, 'EPED', 'Educación', 'BACHILLER', 'B', 'Educación', 'CICLO REGULAR', 220, 3, '2024-09-17 19:23:53', '2024-09-17 19:44:14', 'ACTIVO'),
(20, 'EPED', 'Educación - Nivel Inicial', 'TITULO', 'T', 'Educación - Nivel Inicial', 'CICLO REGULAR', 220, 3, '2024-09-17 19:25:25', '2024-09-17 19:43:40', 'ACTIVO'),
(21, 'EPED', 'Educación – Especialidad Lengua Española y Quechua', 'TITULO', 'T', 'Educación – Especialidad Lengua Española y Quechua', 'CICLO REGULAR', 220, 3, '2024-09-17 19:25:42', '2024-09-17 19:44:02', 'ACTIVO'),
(22, 'EPED', 'Educación – Especialidad Matemática e Informática', 'TITULO', 'T', 'Educación – Especialidad Matemática e Informática	', 'CICLO REGULAR', 220, 3, '2024-09-17 19:26:00', '2024-09-17 19:43:52', 'ACTIVO');
...
('31129767', '201112496H', 'FIDEL', 'LIMACHI', 'CABEZAS', 'F', '951667981', 'ABANCAY 546', '2024-11-08', '2024-11-08', 'yokolibman@hotmail.com', '', '', 0, 0, 0, 18, '2024-11-08 00:00:00', '2024-11-08 00:00:00'),
('31178472', '201413458I', 'ROBERTO', 'AVALOS', 'PICHIHUA', 'M', '926164578', 'AV. PANAMERICANA', '2014-10-24', '2024-10-24', 'roberto.avalos@gmail.com', '', '', 10, 0, 0, 12, '2024-10-24 00:00:00', '0000-00-00 00:00:00'),
('40032356', '201112496H', 'JESUS', 'CASTANEDA', 'VILLAFUERTE', 'M', '970669439', 'CUSCO 256', '2024-11-08', '2024-11-08', 'jcastanedav@utea.edu.pe', 'fff', '', 0, 0, 0, 18, '2024-11-08 00:00:00', '0000-00-00 00:00:00'),
('40551041', '201804486K', 'ESTEFA', 'POMA', 'ATAO', 'F', '954874750', 'JR. AYACUCHO Nº698', '2024-10-24', '2024-10-24', 'estefapomas510@gmail.com', '', '', 0, 0, 0, 17, '2024-10-24 00:00:00', '0000-00-00 00:00:00'),
('43418032', '200921335H', 'PATRICIA ELEINE', 'VILCA', 'RODRIGUEZ', 'F', '970669439', 'ABANCAY 546', '2024-11-08', '2024-11-08', 'juan235@gamil.com', '', '', 0, 0, 0, 18, '2024-11-08 00:00:00', '2024-11-08 00:00:00'),
('46549475', '201212087-E', 'WILBER', 'PEZUA', 'VIGURIA', 'M', '931832686', 'AV. JOSE MARIA ARGUEDAS S/N', '2024-11-15', '2024-11-15', 'pezua2019@gmail.com', '', '', 0, 0, 0, 17, '2024-11-15 00:00:00', '0000-00-00 00:00:00'),
('47780533', '201210363A', 'YOVANA', 'RIVAS', 'TOLEDO', 'F', '916043728', 'S/N', '2024-10-22', '2024-10-22', 'mariaesther@gmail.com', '', '', 0, 0, 0, 10, '2024-10-22 00:00:00', '0000-00-00 00:00:00'),
('48075152', '201222207J', 'REBECA', 'LOAYZA', 'LAGO', 'F', '966343297', 'JR. TUPAC AMARU', '2024-10-28', '2024-10-28', 'bequitaloayza52@gmail.com', '', '', 0, 0, 0, 17, '2024-10-28 00:00:00', '0000-00-00 00:00:00'),
('48564444', '201165515A', 'KARINA', 'ARREDONDO', 'HUAMAN', 'F', '929629626', 'JR. BENAVIDES N° 232', '2011-04-04', '2017-07-31', 'karina21@gmail.com', '', '', 6, 3, 27, 2, '2024-09-29 00:00:00', '0000-00-00 00:00:00'),
('61679166', '201411493I', 'ANTONIO', 'AVALOS', 'SALINAS', 'M', '914057661', 'AV. PANAMERICANA', '2014-03-24', '2022-10-24', 'antonio.avalossalinas@gmail.com', '', '', 8, 7, 0, 12, '2024-10-24 00:00:00', '0000-00-00 00:00:00'),
('70494703', '201322010D', 'LELY MELUSA', 'ALTAMIRANO', 'LLANTOY', 'F', '969721562', 'JR. JUAN ANTONIO TRELLES Nº 267', '2024-11-14', '2024-11-14', 'lelyaltamirano19@gmail.com', '', '', 0, 0, 0, 17, '2024-11-14 00:00:00', '0000-00-00 00:00:00'),
('71294246', '2015969595G', 'FRANK', 'LUNA', 'FERRO', 'M', '926626262', 'AV. PUNO N° 322', '2015-04-06', '2023-02-23', 'rosmery12@gmail.com', '', '', 7, 10, 18, 14, '2024-09-29 00:00:00', '0000-00-00 00:00:00'),
('72246511', '201615866E', 'SANDRA ROCIO', 'QUISPE', 'RUIZ', 'F', '900438654', 'N/S', '2024-10-24', '2024-10-24', 'quisperuizsandrarocio8@gmail.com', '', '', 0, 0, 0, 17, '2024-10-24 00:00:00', '0000-00-00 00:00:00'),
('72257013', '201612077E', 'BLANCA MISHELL', 'CORDOVA', 'CARDENAS', 'F', '934125069', 'JR. VICTOR SEGURA Nº132', '2024-11-12', '2024-11-12', 'mishellc887@gmail.com', '', '', 0, 0, 0, 17, '2024-11-12 00:00:00', '0000-00-00 00:00:00'),
('72260042', '201612076F', 'JACKELIN MILAGROS', 'CENTENO', 'GONZALES', 'F', '977762791', 'AV. INDUSTRIAL S/N', '2024-11-14', '2024-11-14', 'jackelincenteno11@gmail.com', '', '', 0, 0, 0, 17, '2024-11-14 00:00:00', '0000-00-00 00:00:00'),
('74310364', '201701192B', 'DEYSI', 'QUISPE', 'URPI', 'F', '986138265', 'JR. LOS CODORNICES Nº220', '2024-10-24', '2024-10-24', 'dey311399@gmail.com', '', '', 0, 0, 0, 17, '2024-10-24 00:00:00', '0000-00-00 00:00:00'),
('75863955', '201328529A', 'ROSMERY YASMIN', 'TORRES', 'HURTADO', 'M', '926262626', 'JR. CUSCO N° 232', '2013-04-01', '2021-09-03', 'rosmery12@gmail.com', '', '', 7, 6, 15, 2, '2024-09-29 00:00:00', '2024-09-29 00:00:00'),
('77343773', '201515515A', 'HENRY', 'JURO', 'CORDOVA', 'M', '926226266', 'AV. HUANCAVELICA N° 144', '2015-09-07', '2023-06-24', 'henry122@gmail.com', '', '', 7, 9, 16, 2, '2024-09-29 00:00:00', '0000-00-00 00:00:00'),
('77575576', '201701179E', 'KATY MARGOTH', 'MORALES', 'GUIA', 'F', '932978763', 'AV. CONDEBAMBA S/N', '2024-10-22', '2024-10-22', 'berlyflorparedes@gmail.com', 'FHRINZ.DANIEL@GMAIL.COM', '', 0, 0, 0, 2, '2024-10-22 00:00:00', '2024-10-24 00:00:00'),
('77694479', '201721511A', 'JHIAMIL', 'VILLASANTE', 'ROSELL', 'M', '929662262', 'AV. CANADA N° 448', '2017-09-01', '2023-12-24', 'jhamil12@gmail.com', '', '', 6, 3, 22, 2, '2024-09-29 00:00:00', '0000-00-00 00:00:00'),
('80118607', '200921335H', 'YOKO LIBMAN', 'FLOREZ', 'DELGADO', 'F', '951667981', 'ABANCAY 546', '2024-11-08', '2024-11-08', 'patricia@hotmail.com', '', '', 0, 0, 0, 18, '2024-11-08 00:00:00', '2024-11-08 00:00:00'),
('95654556', '201411458I', 'EDGAR', 'AVALOS', 'SALINAS', 'M', '984402091', 'AV. PANAMERICANA', '2024-10-24', '2024-10-24', 'edgar.avalos@gmail.com', '', '', 0, 0, 0, 12, '2024-10-24 00:00:00', '0000-00-00 00:00:00');
...
('43559383', '201926226G', 'FREDY', 'ALARCON', 'CONTRERAS', 'M', '926626262', 'JR. CUSCO N° 444', '2019-09-06', '2021-04-14', 'fredy12@gmail.com', '', '', 1, 7, 7, 2, '2024-09-29 00:00:00', '0000-00-00 00:00:00'),
('70086232', '2019226622A', 'RODRIGO', 'LOAYZA', 'ELGUERA', 'M', '926626262', 'JR. HUANCAVELICA N° 848', '2019-01-25', '2020-03-04', 'rodrigo12@gmail.com', '', '', 1, 1, 8, 2, '2024-09-29 00:00:00', '0000-00-00 00:00:00');
...
('E0000007', 1, '71294246', 18, 'Cirujano Dentista', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 14, 'PENDIENTE', '2024-09-29 11:40:00', '0000-00-00 00:00:00', 3, 7),
...
('E0000042', 1, '47780533', 16, 'Enfermería', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 10, 'PENDIENTE', '2024-10-22 09:36:00', '0000-00-00 00:00:00', 3, 42),
('E0000043', 2, '40551041', 20, 'Educación - Nivel Inicial', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 17, 'PENDIENTE', '2024-10-24 11:16:00', '0000-00-00 00:00:00', 2, 43),
('E0000044', 2, '72246511', 20, 'Educación - Nivel Inicial', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 17, 'PENDIENTE', '2024-10-24 11:16:00', '0000-00-00 00:00:00', 2, 44),
('E0000045', 2, '74310364', 16, 'Enfermería', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 17, 'PENDIENTE', '2024-10-24 11:24:00', '0000-00-00 00:00:00', 3, 45),
('E0000046', 1, '61679166', 2, '', 'Ingeniería de Sistemas e Informática', 'BACHILLER AUTOMATICO', '', '', '1355', '', '327', '310 -311', '31761', 'controller/registro_general_bachiller/documentos/', 12, 'COLACION', '2024-10-24 12:34:00', '0000-00-00 00:00:00', 1, 46),
('E0000047', 1, '95654556', 2, '', 'Ingeniería de Sistemas e Informática', 'BACHILLER AUTOMATICO', '', '', '1354', '', '326', '310 -311', '31760', 'controller/registro_general_bachiller/documentos/', 12, 'COLACION', '2024-10-24 12:38:00', '0000-00-00 00:00:00', 1, 47),
('E0000048', 1, '31178472', 2, '', 'Ingeniería de Sistemas e Informática', 'BACHILLER AUTOMATICO', '', '', '1353', '', '325', '310 -311', '31759', 'controller/registro_general_bachiller/documentos/', 12, 'COLACION', '2024-10-24 12:38:00', '0000-00-00 00:00:00', 1, 48),
('E0000049', 2, '48075152', 16, 'Enfermería', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 17, 'PENDIENTE', '2024-10-28 09:32:00', '0000-00-00 00:00:00', 3, 49),
('E0000050', 3, '31129767', 19, '', 'Educación', 'BACHILLER AUTOMATICO', '', '', '', '', '', '', '', 'controller/registro_general_bachiller/documentos/', 18, 'PENDIENTE', '2024-11-08 09:22:00', '0000-00-00 00:00:00', 2, 50),
('E0000051', 3, '40032356', 19, '', 'Educación', 'BACHILLER AUTOMATICO', '', '', '', '', '', '', '', 'controller/registro_general_bachiller/documentos/', 18, 'PENDIENTE', '2024-11-08 09:22:00', '0000-00-00 00:00:00', 2, 51),
('E0000052', 3, '80118607', 19, '', 'Educación', 'BACHILLER AUTOMATICO', '', '', '', '', '', '', '', 'controller/registro_general_bachiller/documentos/', 18, 'PENDIENTE', '2024-11-08 09:22:00', '0000-00-00 00:00:00', 2, 52),
('E0000053', 3, '43418032', 19, '', 'Educación', 'BACHILLER AUTOMATICO', '', '', '', '', '', '', '', 'controller/registro_general_bachiller/documentos/', 18, 'PENDIENTE', '2024-11-08 09:22:00', '0000-00-00 00:00:00', 2, 53),
('E0000054', 3, '31129767', 1, 'Ingeniero de Sistemas e Informática', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 18, 'PENDIENTE', '2024-11-08 09:35:00', '0000-00-00 00:00:00', 1, 54),
('E0000055', 3, '80118607', 16, 'Enfermería', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 18, 'PENDIENTE', '2024-11-08 09:35:00', '0000-00-00 00:00:00', 3, 55),
('E0000056', 3, '43418032', 16, 'Enfermería', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 18, 'PENDIENTE', '2024-11-08 09:35:00', '0000-00-00 00:00:00', 3, 56),
('E0000057', 2, '72257013', 12, 'Contador Público', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 17, 'PENDIENTE', '2024-11-12 09:40:00', '0000-00-00 00:00:00', 2, 57),
('E0000058', 2, '72260042', 12, 'Contador Público', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 17, 'PENDIENTE', '2024-11-14 15:48:00', '0000-00-00 00:00:00', 2, 58),
('E0000059', 2, '70494703', 12, 'Contador Público', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 17, 'PENDIENTE', '2024-11-14 15:48:00', '0000-00-00 00:00:00', 2, 59),
('E0000060', 2, '46549475', 7, 'Ingeniero Ambiental', '', 'TESIS', '', '', '', '', '', '', '', 'controller/registro_general/documentos/', 17, 'PENDIENTE', '2024-11-15 14:22:00', '0000-00-00 00:00:00', 1, 60);
...
(1, 'Ingeniería', 1, 'ACTIVO', '2024-09-17 16:58:20', '0000-00-00 00:00:00'),
(2, 'Ciencias de la Salud', 3, 'ACTIVO', '2024-09-17 16:58:42', '0000-00-00 00:00:00'),
(3, 'Ciencias Jurídicas Contables y Sociales', 2, 'ACTIVO', '2024-09-17 16:59:26', '0000-00-00 00:00:00');
...
(3, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 2, 'E0000003', '2024-09-29', '0000-00-00 00:00:00'),
(4, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 2, 'E0000004', '2024-09-29', '0000-00-00 00:00:00'),
(5, 'TESIS', 'P', 'PRESENCIAL', 'VARIACIóN DEL COMPORTAMIENTO MECáNICO EN PRISMAS DE ALBAñILERíA TRADICIONAL Y REFORZADAS CON SOGA DRIZA UTILIZANDO BLOQUES HUECOS DE CONCRETO EN LA CIUDAD DE ABANCAY, 2021\r\n', 'SI (TURNITIN)', '16%', 'CENTRO DE INVESTIGACIÓN DE LA CARRERA PROFESIONAL DE INGENIERíA CIVIL', 'https://repositorio.utea.edu.pe/handle/utea/664\r\n', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 2, 'E0000005', '2024-09-29', '0000-00-00 00:00:00'),
(6, 'TESIS', 'P', 'PRESENCIAL', 'INFLUENCIA DE LA SUSTITUCIóN PARCIAL DEL AGREGADO GRUESO POR LADRILLO TRITURADO HúMEDO PARA LA DISMINUCIóN DE FISURAS Y LA RESISTENCIA A LA COMPRESIóN EN LOSAS ALIGERADAS ABANCAY - 2022', 'SI (TURNITIN)', '19%', 'CENTRO DE INVESTIGACIÓN DE LA CARRERA PROFESIONAL DE INGENIERíA CIVIL\r\n', 'https://repositorio.utea.edu.pe/handle/utea/659\r\n', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 2, 'E0000006', '2024-09-29', '2024-09-29 00:00:00'),
(7, 'TESIS', 'P', 'PRESENCIAL', 'GRADO DE CONTAMINACIóN EN UNIFORMES DE ESTUDIANTES DEL LABORATORIO ESTOMATOLóGICO CLíNICO DE LA UNIVERSIDAD TECNOLóGICA DE LOS ANDES, ABANCAY, 2022\r\n', 'SI (TURNITIN)', '12%', 'CENTRO DE INVESTIGACIÓN DE LA CARRERA PROFESIONAL DE ESTOMATOLOGíA\r\n', 'https://repositorio.utea.edu.pe/handle/utea/633\r\n', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 14, 'E0000007', '2024-09-29', '0000-00-00 00:00:00'),
(41, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 2, 'E0000041', '2024-10-22', '2024-10-24 00:00:00'),
(42, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 10, 'E0000042', '2024-10-22', '0000-00-00 00:00:00'),
(44, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 17, 'E0000043', '2024-10-24', '0000-00-00 00:00:00'),
(45, 'TESIS', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 17, 'E0000044', '2024-10-24', '0000-00-00 00:00:00'),
(46, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 17, 'E0000045', '2024-10-24', '0000-00-00 00:00:00'),
(47, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 12, 'E0000046', '2024-10-24', '0000-00-00 00:00:00'),
(48, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 12, 'E0000047', '2024-10-24', '0000-00-00 00:00:00'),
(49, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 12, 'E0000048', '2024-10-24', '0000-00-00 00:00:00'),
(50, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 17, 'E0000049', '2024-10-28', '0000-00-00 00:00:00'),
(52, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 18, 'E0000050', '2024-11-08', '0000-00-00 00:00:00'),
(53, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 18, 'E0000051', '2024-11-08', '0000-00-00 00:00:00'),
(54, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 18, 'E0000052', '2024-11-08', '0000-00-00 00:00:00'),
(55, 'BACHILLER AUTOMATICO', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 18, 'E0000053', '2024-11-08', '0000-00-00 00:00:00'),
(56, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 18, 'E0000054', '2024-11-08', '0000-00-00 00:00:00'),
(57, 'TESIS', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 18, 'E0000055', '2024-11-08', '0000-00-00 00:00:00'),
(58, 'TESIS', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 18, 'E0000056', '2024-11-08', '0000-00-00 00:00:00'),
(61, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 17, 'E0000057', '2024-11-12', '0000-00-00 00:00:00'),
(62, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 17, 'E0000058', '2024-11-14', '0000-00-00 00:00:00'),
(63, 'TESIS', 'P', 'PRESENCIAL', '', '', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 17, 'E0000059', '2024-11-14', '0000-00-00 00:00:00'),
(64, 'TESIS', 'P', 'PRESENCIAL', '', 'SI (TURNITIN)', '', '', '', '', '', '', '0000-00-00', '0000-00-00', '0000-00-00', 'PRESENCIAL', 17, 'E0000060', '2024-11-15', '0000-00-00 00:00:00');
...
(20, 'Derecho Ambiental', 'MAESTRIA', 'M', 'Maestro en Derecho Ambiental', 'CICLO REGULAR', 48, 'ACTIVO', 9, '2024-09-19 22:12:23', '2024-09-19 22:14:24'),
(21, 'Pedagogía en Educación Superior', 'MAESTRIA', 'M', 'Maestro en Pedagogía en Educación Superior', 'CICLO REGULAR', 48, 'ACTIVO', 9, '2024-09-19 22:14:50', '0000-00-00 00:00:00'),
(22, 'Proyectos de Inversión', 'MAESTRIA', 'M', 'Maestro en Proyectos de Inversión', 'CICLO REGULAR', 48, 'ACTIVO', 9, '2024-09-19 22:15:08', '0000-00-00 00:00:00'),
(23, 'Salud Pública', 'MAESTRIA', 'M', 'Maestro en Salud Pública', 'CICLO REGULAR', 48, 'ACTIVO', 9, '2024-09-19 22:15:22', '0000-00-00 00:00:00');
...
(2, 'jersson', '$2y$12$4sdZ0JiawrMqhJMVIG0waO.thvqVgZ7VjhBf11Vp5YOxQAIov4zKu', '2023-08-25', NULL, 1, NULL, 'ACTIVO', 2, 'Administrador', 2, NULL, NULL),
(10, 'FIDEL2024', '$2y$12$QAaSWD74EAhXGTBVKG6nVO5mU9MTbeClBAEoVaoyy1VyjVph/yd6C', '2024-09-17', NULL, 13, NULL, 'ACTIVO', 16, 'Secretario (a)', 2, NULL, NULL),
(11, 'ERIKA2024', '$2y$12$rVllv4LbW3h8lYmlTbmi5uV5EK9P.WRdDuh1KbxlLfioCXtia2wN6', '2024-09-17', NULL, 14, NULL, 'ACTIVO', 16, 'Administrador', 2, NULL, NULL),
(12, 'ANTONIO2024', '$2y$12$MYZ3k6x3m6e3vxOm12u5xOKeEdKriKIlpVVwPaU/s9I0CeebEo5M6', '2024-09-17', NULL, 15, NULL, 'ACTIVO', 16, 'Administrador', 2, NULL, NULL),
(13, 'admin', '$2y$12$MVn1olMJH17U4iBPV6wTYufpv6p9tkFGFMsAGGJeRKhAivGFcBetu', '2024-09-29', NULL, 16, NULL, 'ACTIVO', 16, 'Administrador', 2, NULL, NULL),
(14, 'secre', '$2y$12$w1OM1VAD8F4gagw2Vqlepeclv/o6kCkDPh4qTkjz/XHvJkUKcfS0C', '2024-09-29', NULL, 17, NULL, 'ACTIVO', 16, 'Secretario (a)', 2, NULL, NULL),
(15, 'LEONIDAS2024', '$2y$12$u/tYQ7yirGZPjwAJttFVUuUGTyFbq2XEKMPRQgJOyyZah/FGefZAO', '2024-10-02', NULL, 18, NULL, 'ACTIVO', 16, 'Secretario (a)', 2, NULL, NULL),
(16, 'LUI2024', '$2y$12$WbBiP6tPsGcONLySU.K7eeBTla82m9x2iMRm4kXrCEQIge5wpaPma', '2024-10-02', NULL, 19, NULL, 'ACTIVO', 16, 'Secretario (a)', 2, NULL, NULL),
(17, 'abigail_2024', '$2y$12$c4DtLu6YACFN2mpYW6r3JOsuynDjRSW3ez0vCFB0QrtwEuAGvze2S', '2024-10-05', NULL, 21, NULL, 'ACTIVO', 16, 'Secretario (a)', 2, NULL, NULL),
(18, 'josesu2024', '$2y$12$hf7kdo5gMvzg5R6iWL0/LOcDPG2F6T4rCCu61lhFtMzst5SICyXia', '2024-10-05', NULL, 20, NULL, 'ACTIVO', 16, 'Secretario (a)', 2, NULL, NULL);
...
--
ALTER TABLE `area`
  MODIFY `area_cod` int(11) NOT NULL AUTO_INCREMENT COMMENT 'Codigo auto-incrementado del movimiento del area', AUTO_INCREMENT=19;
...
--
ALTER TABLE `colacion`
  MODIFY `id_colacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT de la tabla `colacion_posgrado`
--
ALTER TABLE `colacion_posgrado`
  MODIFY `id_colacion` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT de la tabla `diploma`
--
ALTER TABLE `diploma`
  MODIFY `Id_Diploma` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;

--
-- AUTO_INCREMENT de la tabla `diploma_posgrado`
--
ALTER TABLE `diploma_posgrado`
  MODIFY `Id_Diploma` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
...
--
ALTER TABLE `escuela_profesional`
  MODIFY `Id_escuela` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=25;

--
-- AUTO_INCREMENT de la tabla `facultad`
--
ALTER TABLE `facultad`
  MODIFY `Cod_facultad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `modalidad`
  MODIFY `Id_modalidad` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=65;
...
--
ALTER TABLE `expediente`
  ADD CONSTRAINT `expediente_ibfk_1` FOREIGN KEY (`Dni`) REFERENCES `estudiante` (`Dni`) ON DELETE CASCADE,
  ADD CONSTRAINT `fk_autopre` FOREIGN KEY (`id_autoridad`) REFERENCES `autoridades` (`Cod_autoridad`) ON UPDATE CASCADE,
  ADD CONSTRAINT `fk_cede` FOREIGN KEY (`Id_cede`) REFERENCES `cede` (`Id_cede`) ON DELETE CASCADE ON UPDATE CASCADE,
...
ALTER TABLE `expediente_posgrado`
  ...
  ADD CONSTRAINT `expediente_posgrado_ibfk_6` FOREIGN KEY (`Dni`) REFERENCES `estudiante_posgrado` (`Dni`);
...
ALTER TABLE `modalidad`
  ...
  ADD CONSTRAINT `modalidad_ibfk_1` FOREIGN KEY (`Id_expediente`) REFERENCES `expediente` (`Id_expediente`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE `modalidad_posgrado`
  ...
  ADD CONSTRAINT `modalidad_posgrado_ibfk_3` FOREIGN KEY (`Id_expediente`) REFERENCES `expediente_posgrado` (`Id_expediente`) ON UPDATE CASCADE;
