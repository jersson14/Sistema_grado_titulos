...
$mpdf->WriteHTML('<h1 style="text-align:center; font-size: '.$tamaño.'px;margin-left: -70px;font-family: mtcorsva;">'.$estudiante.'</h1>');
        ...
        if ($row1['Id_escuela'] == 24 || $row1['Id_escuela'] == 25) {
            $mpdf->SetXY(0, 123); 
            $mpdf->WriteHTML('<h1 style="text-align:center;font-size: 22px;margin-left: -70px;font-family: mtcorsva;">' . $row1['Escuela'] . '</h1>');
        } else {
            $mpdf->SetXY(0, 120.5);
