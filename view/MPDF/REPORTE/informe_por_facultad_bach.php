...
$fac = $mysqli->real_escape_string($_GET['fac']);
...
WHERE Grado_academico = '$grado' and escuela_profesional.Id_facultad='$fac' AND expediente.created_at BETWEEN '$fedes' AND '$fehas'
...
<body>
    ...
    <table class="header-table" style="font-family: Arial, Helvetica, sans-serif;">
        ...
        <tr>
			...
			<td style="padding-right: 0px;font-family: \'Times New Roman\', Times, serif;"><b>:</b></td>
            <td><b style="padding-right: 70px;font-family: \'Times New Roman\', Times, serif;font-size: 12px;">CONFORMIDAD DE EXPEDIENTES DE BACHILLER EN '.$row1['Titulo_de'].'</b></td>
        </tr>
        <tr>
    ...
    <div class="justify-next" style="text-align:justify; font-family: \'Times New Roman\', Times, serif; margin-top: 0;font-size: 12px;">
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Me dirijo a usted para saludarle y, en estricto cumplimiento al Reglamento General de Grados y Títulos y al Estatuto vigente, remito informe de conformidad de expedientes para optar el Titulo profesional en la <b>FACULTAD DE '.$row1['Facultad'].'</b> segun el siguiente detalle:</p>
    </div>
    <div class="justify-next" style="text-align:justify; font-family: \'Times New Roman\', Times, serif; margin-top: 0;font-size: 12px;">
        <u><b><br>EXPEDIENTE DE BACHILLER DE LA FACULTAD DE '.$row1['Facultad'].'</b></u>
    </div>
';
...
$html .= '
    ...
    <div class="justify-next" style="text-align:justify; font-family: \'Times New Roman\', Times, serif; margin-top: 0;font-size: 12px;">
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; Adjunto expedientes a fin de continuar con el trámite correspondiente, la aprobación por su Facultad y luego elevar al Consejo Universitario, a efecto de programar fecha y hora para la ceremonia de colación.</p>
    </div>
