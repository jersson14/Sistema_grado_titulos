...
while($row1 =$resultado->fetch_assoc()){
	$tituloMayuscula = strtoupper($row1['Titulo_de']);
...
<body>
    ...
    <table class="header-table" style="font-family: Arial, Helvetica, sans-serif;">
        ...
        <tr>
			...
			<td style="padding-right: 0px;font-family: \'Times New Roman\', Times, serif;"><b>:</b></td>
            <td><b style="padding-right: 70px;font-family: \'Times New Roman\', Times, serif;font-size: 12px;">Conformidad de Expedientes de Título de '.$row1['Titulo_de'].'</b></td>
        </tr>
        <tr>
    ...
    <div class="justify-next" style="text-align:justify; font-family: \'Times New Roman\', Times, serif; margin-top: 0;font-size: 12px;">
        <p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Me dirijo a usted para saludarle y, en estricto cumplimiento al Reglamento General de Grados y Títulos y al Estatuto vigente, remito informe de conformidad de expedientes para optar el Titulo Profesional de <b>'.$row1['Titulo_de'].'</b>, Programa Profesional de <b>'.$row1['Escuela'].'</b> de acuerdo al siguiente detalle:</p>
    </div>
    <div class="justify-next" style="text-align:justify; font-family: \'Times New Roman\', Times, serif; margin-top: 0;font-size: 12px;">
        <u><b><br>EXPEDIENTE(S) DE TÍTULO DE '.mb_strtoupper($tituloMayuscula).'</b></u>
    </div>
';
