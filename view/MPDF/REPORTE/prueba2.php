...
WHERE
    cede.cede_nombre = 'SEDE CENTRAL' AND colacion.fecha_colación='2024-04-05' AND escuela_profesional.Grado_academico='TITULO' 
...
INNER JOIN informe 
WHERE
    cede.cede_nombre = 'SEDE CENTRAL' AND colacion.fecha_colación='2024-04-05' AND escuela_profesional.Grado_academico='BACHILLER' 
...
<br><br><div class="justify-next" style="text-align: justify; font-family: Impact, sans-serif;">
     ...
     <div class="justify-next" style="text-align:justify; font-family: \'Times New Roman\', Times, serif; margin-top: 0;font-size: 13px;">
        ...
        deberán apersonarse a la Unidad de Grados y Títulos el 27 de junio en hora de oficina.
        </p>
        <p>La ceremonia se cumplirá el 28 de junio a las 9.00 a.m. en el auditorio José María
