...
<script src="../js/console_diploma_bachiller.js?rev=<?php echo time();?>"></script>
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b>LISTADO DE DIPLOMAS DE BACHILLERES</b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Diplomas de Bachilleres</b></h3>
                <button class="btn btn-success float-right" onclick="AbrirModal()"><i class="fas fa-plus"></i> Nuevo Registro</button>
