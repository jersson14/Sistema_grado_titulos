...
<script src="../js/console_diploma_posgrado.js?rev=<?php echo time();?>"></script>
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b>LISTADO DE DIPLOMAS DE POSGRADO</b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Diplomas de Posgrados</b></h3>
                ...
                <div class="table-responsive" style="text-align:center">
                  <div class="card-body">
                    <table id="tabla_diploma_posgrado" class="table table-striped table-bordered" style="width:100%">
                        <thead style="background-color:#0A5D86;color:#FFFFFF; ">
                            <tr>
                                ...
                                <th style="text-align:center">Acci&oacute;n</th>                            </tr>
                        </thead>
                    </table>
                  </div>
                </div>       
