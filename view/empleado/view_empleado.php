    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-4 form-group">
            <label for="">Fecha Nacimiento<b style="color:red">(*)</b>:</label>
          ...
          <div class="col-4 form-group">
            <label for="">Modalidad<b style="color:red">(*)</b>:</label>
              <select class="form-control" id="select_modalidad" style="width:100%">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-4 form-group">
            <label for="">Modalidad<b style="color:red">(*)</b>:</label>
              <select class="form-control" id="txt_modalidad_editar" style="width:100%">
                <option value="CAS">CAS</option>
                <option value="Funcionario">FUNCIONARIO</option>
                <option value="Practicante">PRACTICANTE</option>
                <option value="Servidor Público">SERVIDOR PÚBLICO</option>
      ...
      <div class="modal-body">
        <div class="row">
          <div class="col-12">
            ...
            <label for="">Subir Foto<b style="color:red">(*)</b>:</label>
