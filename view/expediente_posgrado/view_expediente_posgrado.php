<script src="../js/console_expediente_posgrado.js?rev=<?php echo time();?>"></script>
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b>EXPEDIENTE DE POSGRADO</b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Expedientes Posgraduados</b></h3>
              </div>
                ...
                <div class="table-responsive" style="text-align:center">
                  <div class="card-body">
                    <table id="tabla_expediente_posgrado" class="table table-striped table-bordered" style="width:100%">
                        <thead style="background-color:#0A5D86;color:#FFFFFF; ">
                            <tr>
                                ...
                                <th style="text-align:center">Maestro en</th>
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-3 form-group">
                ...
                <input type="text" class="form-control" id="select_grado" readonly>
            </div>
            <div class="col-3 form-group">
                <label for="" style="font-size:small;">Programa:</label>
                <input type="text" class="form-control" id="select_program" readonly>
            </div>
            <div class="col-4 form-group">
                <label for="" style="font-size:small;">Grado de maestro en:</label>
                <input type="text" class="form-control" id="txt_maestria" readonly>                           
            </div>
            <div class="col-4 form-group">
                <label for="" style="font-size:small;">Modalidad:</label>
                <input type="text" class="form-control" id="txt_modalidad" readonly>                           
            </div>
            <div class="col-4 form-group">
                <label for="" style="font-size:small;">Acto academico:</label>
                <input type="text" class="form-control" id="txt_academi" readonly>                           
            </div>
            <div class="col-4 form-group">
            ...
            <div class="col-4 form-group">
                <label for="" style="font-size:small;">Dirctor:</label>
                <input type="text" class="form-control" id="txt_director" readonly>
            </div>
       </div>
       </div>
