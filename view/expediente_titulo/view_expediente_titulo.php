<script src="../js/console_expediente_titulo.js?rev=<?php echo time();?>"></script>
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b>EXPEDIENTE DE TITULADOS</b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Expedientes Titulados</b></h3>
              </div>
    ...
    <h5 class="" id="lb_titulo_datos5" style="color:white;"></h5>
      ...
      <div class="modal-body">
        <div class="row">
            ...
            <div class="col-4 form-group">
                <label for="" style="font-size:small;">Titulo de:</label>
                <input type="text" class="form-control" id="txt_titulo" readonly>                           
            </div>
            <div class="col-4 form-group">
