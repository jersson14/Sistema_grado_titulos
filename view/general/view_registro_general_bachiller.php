...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0"><b>REGISTRO GENERAL DE BACHILLER</b></h1>
            </div><!-- /.col -->
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    <li class="breadcrumb-item"><a href="../index.php">MENU</a></li>
                    <li class="breadcrumb-item active">BACHILLERES</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Bachiller</b></h3>
                    ...
                    <div class="table-responsive" style="text-align:left">
                        <div class="card-body">
                            <div class="row" style="border: 1px solid #ccc; padding: 15px; border-radius: 8px;">
                                ...
                                <div class="col-12 col-md-3" role="document">
                                    <label for="">&nbsp;</label><br>
                                    <button onclick="listar_expedientes_bachiller()" class="btn btn-success mr-2" style="width:100%" onclick><i class="fas fa-search mr-1"></i>Buscar todos</button>
                                </div>
                            </div>
                        </div>
                        <div class="table-responsive" style="text-align:left">
                        ...
                        <div class="table-responsive" style="text-align:center">
                            <div class="card-body">
                                <table id="tabla_registro_general_bachiller" class="table table-striped table-bordered" style="width:100%">
    ...
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="lb_titulo_datos"><b>Datos del Bachiller</b></h5>
            </div>
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                                        <div class="row">
                                            ...
                                            <div class="col-4 form-group">
                                                ...
                                                <input type="text" class="form-control" id="txt_bachiller">
                                            </div>
                                            <div class="col-3 form-group">
                                            ...
                                            <div class="col-12">
                                                <div class="row">
                                                    ...
                                                    <div class="col-3 form-group">
                                                        ...
                                                        <textarea class="form-control" id="txt_trabajo_inve" rows="2" style="resize:none" disabled></textarea>
                                                    </div>
                                                    <div class="col-3 form-group">
                                                        <label for="" style="font-size:small;">Metadato o Link<b style="color:red">(SOLO TESIS)</b>:</label>
                                                        <textarea class="form-control" id="txt_metadata" rows="2" style="resize:none" disabled></textarea>
                                                    </div>

                                                    <div class="col-2 form-group">
                                                        <label for="" style="font-size:small;">Turnitin<b style="color:red">(SOLO TESIS)</b>:</label>
                                                        <input type="text" class="form-control" id="txt_turni" disabled>
                                                    </div>
                                                    <div class="col-2 form-group">
                                                        <label for="" style="font-size:small;">Porcentaje<b style="color:red">(SOLO TESIS)</b>:</label>
                                                        <input type="text" class="form-control" id="txt_porce" disabled>
                                                    </div>
                                                    <div class="col-3 form-group">
                                                        <label for="" style="font-size:small;">Centro de Investigación<b style="color:red">(*)</b>:</label>
                                                        <textarea class="form-control" id="txt_centro_inve" rows="2" style="resize:none" disabled></textarea>
                                                    </div>
                                                    ...
                                                    <div class="col-12" style="text-align:center">
                                                        <button class="btn btn-success btn-lg" onclick="Registrar_Bachiller()" id="btn_registro"><i class="fas fa-save"></i><b> REGISTRAR BACHILLER</b></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<div class="modal fade" id="modal_editar" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title" id="lb_titulo_datos"><b>Editar Datos del Bachiller</b></h5>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-12">
                                ...
                                <div class="tab-content" id="custom-tabs-one-tabContent3">
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-one-profile5" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab5">
                                        <div class="row">
                                            ...
                                            <div class="col-4 form-group">
                                                <label for="" style="font-size:small;">Grado Académico de Bachiller en<b style="color:red">(*)</b>:</label>
                                                <input type="text" class="form-control" id="txt_bachiller_editar">
                                            </div>
                                            <div class="col-3 form-group">
                                                <label for="" style="font-size:small;">Modalidad<b style="color:red">(*)</b>:</label>
                                                <select name="" id="txt_modalidad_editar" class="form-control">
                                                    <option value="CURSO &QUOT;TRABAJO DE INVESTIGACIÓN&QUOT;">CURSO "TRABAJO DE INVESTIGACIÓN"</option>
                                                    <option value="BACHILLER AUTOMATICO">BACHILLER AUTOMATICO</option>
                                                </select>
                                            </div>
                                            <div class="col-3 form-group">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-12 form-group" style="border: 1px solid #ccc; padding: 10px;" id="datos_antiguos">
                                                        ...
                                                        <div class="row">
                                                            ...
                                                            <!-- NUEVA SECCIÓN SUNEDU -->
                                                            <div class="col-12" style="margin-top: 20px; margin-bottom: 10px;">
                                                                <hr>
                                                                <h6 style="color: #1FA0E0; font-weight: bold;">
                                                                    <i class="fas fa-graduation-cap"></i> CICLO DE TRABAJO DE INVESTIGACIÓN
                                                                </h6>
                                                            </div>
                                                            ...
                                                            <div class="col-6 form-group d-flex align-items-end">
                                                                <div class="alert alert-info" style="margin-bottom: 0; padding: 10px; width: 100%;">
                                                                    <i class="fas fa-info-circle"></i>
                                                                    <small><b>Nota:</b> Este dato aparecerá en los diplomas</small>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-12" style="text-align:center">
                                                        <button class="btn btn-success btn-lg" onclick="Modificar_Bachiller()" id="btn_editar"><i class="fas fa-edit"></i><b> MODIFICAR BACHILLER</b></button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
    ...
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content">
            ...
            <div class="modal-footer">
                ...
                <button type="button" class="btn btn-success" onclick="Agregar_diploma()">
                                ...
                                <div class="tab-content" id="custom-tabs-one-tabContent3">
                                    ...
                                    <div class="tab-pane fade" id="custom-tabs-one-profile3" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab3">
                                        <div class="row">
                                            ...
                                            <div class="col-4 form-group">
                                                <label for="" style="font-size:small;">Grado Académico de Bachiller en<b style="color:red">(*)</b>:</label>
                                                <input type="text" class="form-control" id="txt_bachiller_mas" readonly>
                                            </div>
                                            <div class="col-3 form-group">
                                                <label for="" style="font-size:small;">Modalidad<b style="color:red">(*)</b>:</label>
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-5 form-group">
                        ...
                        <input type="text" class="form-control" id="txt_gr" value="BACHILLER">
                    </div>
                    <div class="col-5 form-group">
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="row">
                    ...
                    <div class="col-5 form-group">
                        <label for="">Grado académico<b style="color:red">(*)</b>:</label>
                        <input type="text" class="form-control" id="txt_gr_filial" value="BACHILLER">
                    </div>
                    <div class="col-5 form-group">
                        <label for="">Facultad<b style="color:red">(*)</b>:</label>
...
<div class="modal fade" id="modal_pasar_titulado" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header" style="background-color:#1FA0E0">
                <div class="col-12 form-group" style="color:white; margin-bottom: 0;">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    <div class="col-12 form-group" style="color:red">
                        <h7><b>Nota:</b> Este formulario es para enviar todo los datos a titulados una vez modificado este registro lo podra ver en <b>Registro de Titulo</b></h7>
                    </div>
                    <div class="col-12 form-group">
                        <div class="col-12 form-group">
                            <input type="text" id="txtidexpe" hidden>
                            <input type="text" id="txtidiautoridad" hidden>
                            <input type="text" id="select_sexo_pasar" hidden>
                        ...
                        <div class="col-12 form-group">
                            ...
                            <input type="text" class="form-control" id="txt_titulo_pasar">
                        </div>
                        <div class="col-12 form-group">
                            <label for="" style="font-size:small;">Modalidad<b style="color:red">(*)</b>:</label>
                ...
                <div class="modal-footer">
                    <button type="button" class="btn btn-danger" data-dismiss="modal"><i class="fas fa-times ml-1"></i> Cerrar</button>
                    <button type="button" class="btn btn-success" onclick="Pasar_titulo()"><i class="fas fa-file"></i> Enviar a Titulados</button>
                </div>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        document.getElementById('txt_modalidad_editar').addEventListener('change', function() {
            ...
            const inputToDisable7 = document.getElementById('txt_trabajo_inve_editar');
            const inputToDisable8 = document.getElementById('txt_metadata_editar');
            const inputToDisable9 = document.getElementById('txt_turni_editar');
            const inputToDisable10 = document.getElementById('txt_porce_editar');
            const inputToDisable11 = document.getElementById('txt_centro_inve_editar');

            if (this.value === 'BACHILLER AUTOMATICO') {
    ...
    <script>
        document.getElementById('txt_modalidad').addEventListener('change', function() {
            const inputToDisable = document.getElementById('txt_trabajo_inve');
            const inputToDisable2 = document.getElementById('txt_metadata');
            const inputToDisable3 = document.getElementById('txt_turni');
            const inputToDisable4 = document.getElementById('txt_porce');
            const inputToDisable5 = document.getElementById('txt_centro_inve');
