...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b>REGISTRO GENERAL DE POSGRADOS</b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
 ...
 <div class="d-flex justify-content-end">
                    ...
                    <button class="btn btn-primary" onclick="imprimir_info()"><i class="fas fa-print"></i> Imprimir Informe</button>
                </div>
...
<div class="modal fade" id="modal_registro" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      ...
      <h5 class="modal-title" id="lb_titulo_datos"><b>Datos del Posgraduado</b></h5>
      </div>
                ...
                <div class="tab-pane fade" id="custom-tabs-one-profile" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab">
                    <div class="row">
                            ...
                            <div class="col-5 form-group">
                                ...
                                <select class="form-control" id="select_programa" style="width:100%"></select>
                            </div>
                            <div class="col-5 form-group">
                                <label for="" style="font-size:small;">Denominación<b style="color:red">(*)</b>:</label>
                                <input type="text" class="form-control" id="txt_denominacion">
                            ...
                            <div class="col-3 form-group">
                                ...
                                <select name="" id="txt_modalidad" class="form-control">
                                    ...
                                    <option value="ARTICULO CIENTÍFICO">ARTICULO CIENTÍFICO</option>
                                </select>                           
                            </div>
                            <div class="col-3 form-group">
                    ...
                    <div class="col-12">
                        ...
                        <div class="col-12 form-group" style="color:red">
                            ...
                            <div class="col-3 form-group">
                                ...
                                <textarea class="form-control" id="txt_proceden_pais"  rows="2" style="resize:none"></textarea>
                            </div>
                            <div class="col-3 form-group">
                                <label for="" style="font-size:small;">Procedencia de Unive. Extran. (Opcional):</label>
                                <textarea class="form-control" id="txt_procedeni_univer"  rows="2" style="resize:none"></textarea>
                            </div>
                            <div class="col-3 form-group">
                                <label for="" style="font-size:small;">Procedencia de Grado Extran. (Opcional):</label>
                                <textarea class="form-control" id="txt_proceden_grado"  rows="2" style="resize:none"></textarea>
                            </div>
                            <div class="col-3 form-group">
                            ...
                            <div class="col-12" style="text-align:center">
                                <button class="btn btn-success btn-lg" onclick="Registrar_Posgraduado()" id="btn_registro"><i class="fas fa-save"></i><b> REGISTRAR GRADO</b></button>
                            </div>
                        </div>
                    </div>
                  </div>
...
<div class="modal fade" id="modal_editar" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-xl" role="document">
    <div class="modal-content">
      <div class="modal-header">
      <h5 class="modal-title" id="lb_titulo_datos"><b>Editar Datos del Posgraduado</b></h5>
      </div>
      <div class="modal-body">
        <div class="row">
        <div class="col-12">
              ...
              <div class="tab-content" id="custom-tabs-one-tabContent3">
                ...
                <div class="tab-pane fade" id="custom-tabs-one-profile5" role="tabpanel" aria-labelledby="custom-tabs-one-profile-tab5">
                    ...
                    <div class="col-12 form-group" style="color:red">
                            ...
                            <div class="col-5 form-group">
                                <label for="" style="font-size:small;">Programa<b style="color:red">(*)</b>:</label>
                                <select class="form-control" id="select_programa_editar" style="width:100%"></select>
                            </div>
                            <div class="col-5 form-group">
                                <label for="" style="font-size:small;">Denominación<b style="color:red">(*)</b>:</label>
                                <input type="text" class="form-control" id="txt_denominacion_editar">
                  ...
                  <div class="row">
                    <div class="col-12">
                        ...
                        <input type="text" id="txt_id_modalidad" hidden> 
                            ...
                            <div class="col-3 form-group">
                                <label for="" style="font-size:small;">Procedencia de País Extran. (Opcional):</label>
                                <textarea class="form-control" id="txt_proceden_pais_editar"  rows="2" style="resize:none"></textarea>
                            </div>
                            <div class="col-3 form-group">
                                <label for="" style="font-size:small;">Procedencia de Unive. Extran. (Opcional):</label>
                                <textarea class="form-control" id="txt_procedeni_univer_editar"  rows="2" style="resize:none"></textarea>
                            </div>
                            <div class="col-3 form-group">
                                <label for="" style="font-size:small;">Procedencia de Grado Extran. (Opcional):</label>
                                <textarea class="form-control" id="txt_proceden_grado_editar"  rows="2" style="resize:none"></textarea>
                            </div>
                            <div class="col-3 form-group">
                                <label for="" style="font-size:small;">Fecha de matri. de modalidad (Opcional):</label>
                            ...
                            <div class="col-12" style="text-align:center">
                                <button class="btn btn-success btn-lg" onclick="Modificar_Posgraduado()" id="btn_editar"><i class="fas fa-edit"></i><b> MODIFICAR GRADO</b></button>
                            </div>
                        </div>
                    </div>
                  </div>
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <div class="row">
        <div class="col-12 form-group" style="color:red">
                <h7><b>OJO: Debe seleccionar el programa o maestria y poner la fecha y hora que desea imprimir.</b></h7>
            </div>
         <div class="col-6 form-group">
          ...
          <div class="col-6 form-group">
            ...
            <input type="text" class="form-control" id="txt_gr" value="MAESTRIA">
          </div>
...
//registrar
    $("#select_programa").change(function(){
        ...
        $("#select_programa_editar").change(function(){
        var id_auto=$("#select_programa_editar").val();
        Traerauto(id_auto);
        });


        $("#select_programa_editar").change(function(){
        var id=$("#select_programa_editar").val();
        Traergrado(id);
        });
...
document.getElementById('fechahasta').value = lastDayFormatted;
...
<script>
        document.getElementById('txt_modalidad').addEventListener('change', function() {
            ...
            const inputToDisable6 = document.getElementById('txt_tur');

            if (this.value === 'SUFICIENCIA PROFESIONAL' || this.value === 'ACTUALIZACIÓN PROFESIONAL') {
