...
<script src="../js/console_registro_general_titulo_secre.js?rev=<?php echo time(); ?>"></script>
...
<script>
    ...
    <script>
        ...
        // Lógica de búsqueda Reniec centralizada en ejecutarBusqueda() en console_registro_general_titulo_secre.js
