<script src="../js/console_modalidad_posgrado_repo.js?rev=<?php echo time();?>"></script>
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Modalidad Posgrado</b></h3>
                ...
                <div class="col-12 col-md-3" role="document">
                    <label for="">&nbsp;</label><br>
                    <button onclick="listar_fechas_busqueda()" class="btn btn-danger mr-2" style="width:100%" onclick><i class="fas fa-search mr-1"></i>Buscar Modalidad Posgrado</button>
                </div>
                <div class="col-12 col-md-3" role="document">
                    <label for="">&nbsp;</label><br>
      ...
      <div class="alert alert-warning alert-dismissible" style="text-align:justify">
        ...
        <div class="row">
            ...
            <div class="col-3 form-group">
                ...
                <select name="" id="txt_modo_ob_ediitar" class="form-control">
            ...
            <div class="col-3 form-group">
                <label for="" style="font-size:small;">Procedencia de País Extran. (Opcional):</label>
                <textarea class="form-control" id="txt_proceden_pais_mas_editar"  rows="2" style="resize:none" ></textarea>
            </div>
            <div class="col-3 form-group">
                <label for="" style="font-size:small;">Procedencia de Unive. Extran. (Opcional):</label>
                <textarea class="form-control" id="txt_procedeni_univer_mas_editar"  rows="2" style="resize:none" ></textarea>
            </div>
            <div class="col-3 form-group">
                <label for="" style="font-size:small;">Procedencia de Grado Extran. (Opcional):</label>
                <textarea class="form-control" id="txt_proceden_grado_mas_editar"  rows="2" style="resize:none" ></textarea>
            </div>
            <div class="col-3 form-group">
                <label for="" style="font-size:small;">Fecha de matricula de modalidad (Opcional):</label>
