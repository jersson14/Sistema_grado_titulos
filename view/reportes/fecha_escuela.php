<script src="../js/console_reporte_fecha_escuela.js?rev=<?php echo time();?>"></script>
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">GRADUADOS POR ESCUELAS</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Titulados por programa / escuela profesional</b></h3>
                ...
                <div class="col-12 col-md-3" role="document">
                    ...
                    <label for="txtfechafin">Programa / Escuela profesional:</label>
                        ...
                        <select class="form-control" id="select_escuela" style="width:90%"></select>
                        <div class="valid-input invalid-feedback"></div>
                    </div>
                    </div>
                </div>
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Bachilleres por programa / escuela profesional</b></h3>
                ...
                <div class="col-12 col-md-3" role="document">
                    ...
                    <label for="txtfechafin">Programa / Escuela profesional:</label>
                        ...
                        <select class="form-control" id="select_escuela_bach" style="width:90%"></select>
                        <div class="valid-input invalid-feedback"></div>
                    </div>
                    </div>
                </div>
...
$(document).ready(function () {
  ...
  Cargar_Select_Escuela();
  Cargar_Select_Escuela_bach();
});
var n = new Date();
var y= n.getFullYear();
var m= n.getMonth()+1;
