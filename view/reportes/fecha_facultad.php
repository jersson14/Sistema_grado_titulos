<script src="../js/console_reporte_fecha_facultad.js?rev=<?php echo time();?>"></script>
...
<!-- Content Header (Page header) -->
    <div class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0"><b>REPORTE DE GRADUADOS POR FACULTAD</b></h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="../index.php">MENU</a></li>
              <li class="breadcrumb-item active">GRADUADOS POR FACULTAD</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
        ...
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              ...
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Titulados por FACULTAD</b></h3>
              </div>
                ...
                <div class="col-12 col-md-3" role="document">
                    <div class="form-group">
                    <label for="txtfechafin">Facultad:</label>
                        <div class="input-group mb-2">
                        <div class="input-group-prepend">
                            <div class="input-group-text">
                        ...
                        <select class="form-control" id="select_facultad" style="width:90%"></select>
                        <div class="valid-input invalid-feedback"></div>
                    </div>
                    </div>
                </div>
      ...
      <div class="container-fluid">
        <div class="row">
          ...
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header">
              <h3 class="card-title"><i class="fas fa-file-signature"></i>&nbsp;&nbsp;<b>Listado de Bachilleres por FACULTAD</b></h3>
              </div>
                <div class="table-responsive" style="text-align:left">
                  <div class="card-body">
                  <div class="row">
                ...
                <div class="col-12 col-md-3" role="document">
                    ...
                    <label for="txtfechafin">Facultad:</label>
                        ...
                        <select class="form-control" id="select_facultad_bach" style="width:90%"></select>
                        <div class="valid-input invalid-feedback"></div>
                    </div>
                    </div>
                </div>
                <div class="col-12 col-md-3" role="document">
                    <label for="">&nbsp;</label><br>
                    <button onclick="listar_fechas_busqueda_bach()" class="btn btn-danger mr-2" style="width:100%" onclick><i class="fas fa-search mr-1"></i>Buscar Graduados</button>
                </div>
                </div>
                </div>
