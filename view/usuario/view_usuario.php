                    ...
                    <table id="tabla_usuario" class="table table-striped table-bordered" style="width:100%">
                        <thead style="background-color:#0A5D86;color:#FFFFFF; ">
                            <tr>
                                ...
                                <th style="text-align:center">Área u Oficina</th>
      ...
      <div class="modal-body">
        <div class="row">
          ...
          <div class="col-12">
            ...
            <label for="">Usuario<b style="color:red">(*)</b>:</label>
            <input type="text" class="form-control" id="txt_usu_editar" readonly><br>
          </div>
          <div class="col-8">
            <label for="">Empleado<b style="color:red">(*)</b>:</label>
          ...
          <div class="col-4 form-group">
            <label for="">Sede<b style="color:red">(*)</b>:</label>
              <select class="js-example-basic-single" id="select_sede_editar" style="width:100%">
              </select>          
          </div>
          <div class="col-6">
            <label for="">Área<b style="color:red">(*)</b>:</label>
